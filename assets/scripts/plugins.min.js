!(function (e) {
  ...
  var t = "animsition",
    i = {
      init: function (n) {
        ...
        return o || !(n.browser.length > 0) || (o && this.length)
          ? (i.optionCheck.call(this, n) &&
              e("." + n.overlayClass).length <= 0 &&
              i.addOverlay.call(this, n),
            n.loading &&
              e("." + n.loadingClass).length <= 0 &&
            ...
            this.each(function () {
              ...
              a.data(t) ||
                ...
                r.on("click." + t, n.linkElement, function (t) {
                  t.preventDefault();
                  var n = e(this),
                    a = n.attr("href");
                  2 === t.which ||
      ...
      addLoading: function (t) {
        e(t.loadingParentElement).append(
          '<div class="' + t.loadingClass + '">' + t.loadingInner + "</div>"
        );
      },
      ...
      in: function () {
        ...
        a.loading && i.removeLoading.call(n),
          d && o.removeClass(d),
          p ? i.inOverlay.call(n, c, l) : i.inDefault.call(n, c, l);
      },
      ...
      out: function (n, o) {
        ...
        (s.data(t).outClass = f),
          m ? i.outOverlay.call(a, f, g, o) : i.outDefault.call(a, f, g, o);
      },
  ...
  (function (e) {
    ...
    var t = {
      init: function (t) {
        ...
        return this.each(function () {
          var t = {
            init: function () {
              var i = e(this);
              t.prepareHoverfolio.apply(i),
                t.buildHoverfolio.apply(i),
                n.activeIndex > 0 && t.activeItem.apply(i);
            },
            prepareHoverfolio: function () {
              var t = e(this);
              t.addClass("vlt-hoverfolio"),
                t.wrapInner('<div class="vlt-hoverfolio-inner">'),
                t.find("a").addClass("vlt-hoverfolio-link"),
                t.append(
                  '<div class="vlt-hoverfolio-image"><img src="" alt=""></div>'
                );
            },
                ...
                if (o != i) {
                  if ((a.attr("src", o), 1 == n.randomWidth)) {
                    var s =
                      Math.floor(
                        Math.random() *
                          (n.randomInterval[1] - n.randomInterval[0] + 1)
                      ) + n.randomInterval[0];
                    a.css("max-width", s + "%");
                  } else
                    a.css({
      ...
      destroy: function () {
        this.removeClass("vlt-hoverfolio hovered"),
          this.find("a").removeClass("vlt-hoverfolio-link"),
          this.find(".vlt-hoverfolio-image").remove();
      },
    };
    e.fn.hoverfolio = function (i) {
      return t[i]
        ...
        : "object" != typeof i && i
        ? void e.error("Method: " + i + " does not exists. jQuery.hoverfolio")
  ...
  (function (e) {
    ...
    function i() {
      (a = e.innerWidth || document.documentElement.clientWidth),
        (s = e.innerHeight || document.documentElement.clientHeight);
    }
    function n(e, t, i) {
      e.addEventListener
    ...
    function o(t) {
      e.requestAnimationFrame(function () {
        ...
        for (var e = 0, n = m.length; e < n; e++)
          "scroll" !== t.type && (m[e].coverImage(), m[e].clipContainer()),
            m[e].onScroll();
      });
    }
    Date.now ||
      ...
      v = (function () {
        function e(e, i) {
          ...
          if (
            ...
            !(!l || (d && o.options.noAndroid) || (u && o.options.noIos)))
          ) {
    ...
    (v.prototype.css = function (t, i) {
      if ("string" == typeof i)
        return e.getComputedStyle
          ? e.getComputedStyle(t).getPropertyValue(i)
          : t.style[i];
      i.transform &&
        (c && (i.transform += " translateZ(0)"),
        (i.WebkitTransform =
          i.MozTransform =
          i.msTransform =
          i.OTransform =
      ...
      (v.prototype.init = function () {
        ...
        (o ||
          ...
          t.image.width && t.image.height
            ? e()
            : t.getImageSize(t.image.src, function (i, n) {
        ...
        if (t.image.width && t.image.height) {
          ...
          if (
            ...
            (t.isElementInViewport =
              l.bottom >= 0 && l.right >= 0 && l.top <= s && l.left <= a),
            ...
            if (
              ...
              "absolute" === t.image.position && (b -= n),
                (r.transform = "translateY(" + b + "px)");
            }
      ...
      for (a; a < o; a++)
        if (
          ("object" == typeof i || void 0 === i
            ? e[a].jarallax || (e[a].jarallax = new v(e[a], i))
            : e[a].jarallax && (t = e[a].jarallax[i].apply(e[a].jarallax, n)),
          void 0 !== t)
        )
          return t;
      return e;
  ...
  (function (e) {
    (e.fn.collagePlus = function (t) {
      function i(t, i, o, a) {
        for (
          var s = o.padding * (t.length - 1) + t.length * t[0][3],
            r = o.albumWidth - s,
            l = r / (i - s),
            c = s,
            p = i < o.albumWidth,
          ...
          var u = e(t[d][0]),
            ...
            g = !!(d < t.length - 1);
          o.allowPartialLastRow === !0 &&
            p === !0 &&
            ((h = t[d][1]), (f = t[d][2])),
            (c += h),
            !g &&
              c < o.albumWidth &&
              (o.allowPartialLastRow === !0 && p === !0
                ? (h = h)
                : (h += o.albumWidth - c)),
            h--;
          var m = u.is("img") ? u : u.find("img");
          m.width(h),
            u.is("img") || u.width(h + t[d][3]),
            m.height(f),
            u.is("img") || u.height(f + t[d][4]),
            n(u, g, o),
            m
              .one(
                "load",
                (function (e) {
                  return function () {
                    if ("default" == o.effect)
                      e.animate({ opacity: "1" }, { duration: o.fadeSpeed });
                    else {
      ...
      return this.each(function () {
        var n = 0,
          ...
          s = 1,
          r = e(this);
        (e.fn.collagePlus.defaults.albumWidth = r.width()),
          (e.fn.collagePlus.defaults.padding = parseFloat(
            r.css("padding-left")
          )),
          (e.fn.collagePlus.defaults.images = r.children());
        ...
        l.images.each(function (t) {
          ...
          a.push([this, h, f, u.w, u.h]),
            ...
            l.images.length - 1 == t &&
              0 != a.length &&
              (i(a, n, l, s), delete n, delete a, (n = 0), (a = []), (s += 1));
        });
      });
    }),
  ...
  (function (e) {
    ...
    var i = function (t, n) {
      (this.$element = e(t)),
        (this.options = e.extend({}, i.DEFAULTS, this.dataOptions(), n)),
        this.init();
    };
    (i.DEFAULTS = {
      from: 0,
      ...
      (e.fn.countTo = function (t) {
        return this.each(function () {
          ...
          a && (o && o.stop(), n.data("countTo", (o = new i(this, s)))),
            o[r].call(o);
        });
      });
  }),
  (function (e, t, i, n) {
    ...
    function o(t, i, a) {
      ...
      (s.obj = t),
        (s.$obj = e(t)),
        e.data(s.obj, "cubeportfolio", s),
        i.sortToPreventGaps !== n &&
          ((i.sortByDimension = i.sortToPreventGaps),
          delete i.sortToPreventGaps),
        (s.options = e.extend(
          {},
          e.fn.cubeportfolio.options,
          i,
          s.$obj.data("cbp-options")
        )),
        (s.isAnimating = !0),
        (s.defaultFilter = s.options.defaultFilter),
        (s.registeredEvents = []),
        (s.queue = []),
        (s.addedWrapp = !1),
        e.isFunction(a) && s.registerEvent("initFinish", a, !0);
      var r = s.$obj.children();
      s.$obj.addClass("cbp"),
        (0 === r.length || r.first().hasClass("cbp-item")) &&
          (s.wrapInner(s.obj, "cbp-wrapper"), (s.addedWrapp = !0)),
        (s.$ul = s.$obj.children().addClass("cbp-wrapper")),
        s.wrapInner(s.obj, "cbp-wrapper-outer"),
        (s.wrapper = s.$obj.children(".cbp-wrapper-outer")),
        (s.blocks = s.$ul.children(".cbp-item")),
        (s.blocksOn = s.blocks),
        s.wrapInner(s.blocks, "cbp-item-wrapper"),
        (s.plugins = {}),
        e.each(o.plugins, function (e, t) {
          var i = t(s);
          i && (s.plugins[e] = i);
        }),
        s.triggerEvent("afterPlugins"),
        (s.removeAttrAfterStoreData = e.Deferred()),
        s.loadImages(s.$obj, s.display);
    }
    e.extend(o.prototype, {
      ...
      wrapInner: function (e, t) {
        ...
        if (((t = t || ""), !(e.length && e.length < 1)))
          for (e.length === n && (e = [e]), a = e.length - 1; a >= 0; a--) {
            for (
              o = e[a], s = i.createElement("div"), s.setAttribute("class", t);
              o.childNodes.length;

            )
              s.appendChild(o.childNodes[0]);
            o.appendChild(s);
          }
      },
        ...
        requestAnimationFrame(function () {
          var o = t.find("img").map(function (t, i) {
              if (i.hasAttribute("width") && i.hasAttribute("height")) {
                if (
                  ((i.style.width = i.getAttribute("width") + "px"),
                ...
                if (null === n.checkSrc(i)) n.removeAttrImage(i);
                  ...
                  o.on("load.cbp error.cbp", function () {
                    ...
                    i.srcset
                      ? (o.attr("sizes", i.sizes || "100vw"),
                        o.attr("srcset", i.srcset))
                      : o.attr("src", i.src);
                }
                return null;
              }
      ...
      checkSrc: function (t) {
        ...
        var a = e("<img>");
        i
          ? (a.attr("sizes", t.sizes || "100vw"), a.attr("srcset", i))
          : a.attr("src", o);
        var s = a[0];
        return s.complete && s.naturalWidth !== n && 0 !== s.naturalWidth
          ? null
          : s;
      },
      display: function () {
          ...
          : (t.blocks.removeAttr("style"),
            t.blocks.each(function (i, n) {
              ...
              (o.height = r),
                ...
                (o.width = s),
                (o.widthAndGap = s + t.options.gapVertical);
            }),
      ...
      filterFinish: function () {
        var e = this;
        e.blocksAreSorted && e.sortBlocks(e.blocks, "index"),
          (e.isAnimating = !1),
      ...
      responsiveLayout: function () {
        ...
        (t.cols =
          ...
          t.blocks.each(function (i, n) {
            ...
            "mosaic" === t.options.layoutMode &&
              (s = t.getColsMosaic(a.widthInitial)),
              (o = t.columnWidth * s - t.options.gapVertical),
              (n.style.width = o + "px"),
              (a.width = o),
              (a.widthAndGap = o + t.options.gapVertical),
              (n.style.height = "");
          });
        var i = [];
        t.blocks.each(function (t, n) {
          e.each(e(n).find("img").filter("[width][height]"), function (t, n) {
            ...
            i.push({ el: n, width: o, height: Math.round(o / r) });
          });
        }),
      ...
      getColsMosaic: function (e) {
        ...
        return (
          (i = i % 1 >= 0.79 ? Math.ceil(i) : Math.floor(i)),
      ...
      getColumnsAuto: function () {
        ...
        var t =
          e.blocks.first().data("cbp").widthInitial + e.options.gapVertical;
      ...
      getColumnsBreakpoints: function () {
        var t,
          ...
          n = i.width;
        return (
          e.each(i.options.mediaQueries, function (e, i) {
      ...
      positionateItems: function () {
        ...
        i.blocksOn.removeClass("cbp-item-off").each(function (i, n) {
          ...
          i.blocksAreSorted && i.sortBlocks(i.blocks, "index");
      },
      resizeMainContainer: function () {
        var t,
          i = this,
          a = Math.max(
            i.freeSpaces.slice(-1)[0].topStart - i.options.gapHorizontal,
            0
          );
        return (
          ...
          a === i.height
            ? void i.triggerEvent("resizeMainContainer")
            : ((i.obj.style.height = a + "px"),
              i.height !== n &&
                (o.private.modernBrowser
                  ? i.$obj.one(o.private.transitionend, function () {
      ...
      registerEvent: function (e, t, i) {
        ...
        n.registeredEvents[e] || (n.registeredEvents[e] = []),
          n.registeredEvents[e].push({ func: t, oneTime: i || !1 });
      },
      triggerEvent: function (e, t) {
        ...
        if (o.registeredEvents[e])
          for (i = 0, n = o.registeredEvents[e].length; i < n; i++)
            o.registeredEvents[e][i].func.call(o, t),
              o.registeredEvents[e][i].oneTime &&
                (o.registeredEvents[e].splice(i, 1), i--, n--);
      },
      addItems: function (t, i, n) {
        ...
        a.wrapInner(t, "cbp-item-wrapper"),
          ...
          o.private.modernBrowser
            ? t.last().one(o.private.animationend, function () {
                a.addItemsFinish(t, i);
              })
            : a.addItemsFinish(t, i),
          a.loadImages(t, function () {
            if ((a.$obj.addClass("cbp-updateItems"), "append" === n))
          ...
          t.each(function (t, i) {
            n.blocks.each(function (t, a) {
              if (i === a) {
                ...
                n.blocks.splice(t, 1),
                  o.private.modernBrowser
                    ? (s.one(o.private.animationend, function () {
                        s.remove();
                      }),
                      s.addClass("cbp-removeItem"))
                    : s.remove();
              }
            });
          }),
  ...
  (function (e, t, i, n) {
    ...
    e.extend(o.prototype, {
      ...
      getSpaceIndexAndBlock: function () {
        ...
        return (
          e.each(t.freeSpaces, function (n, o) {
            ...
            return (
              t.blocksOn.each(function (t, r) {
                var l = e(r).data("cbp");
                if (l.pack !== !0)
                  return l.widthAndGap <= a && l.heightAndGap <= s
                    ? ((l.pack = !0),
                      (i = { spaceIndex: n, dataBlock: l }),
                      (l.leftNew = o.leftStart),
                      (l.topNew = o.topStart),
                      !1)
                    : void 0;
              }),
              !t.blocksAreSorted && t.options.sortByDimension && n > 0
                ? ((i = null), !1)
                : null === i && void 0
            );
          }),
      ...
      generateF1F2: function (e, t) {
        ...
        i.freeSpaces.splice(e, 1),
          o.leftEnd > o.leftStart &&
            o.topEnd > o.topStart &&
            (i.freeSpaces.splice(e, 0, o), e++),
          a.leftEnd > a.leftStart &&
            a.topEnd > a.topStart &&
            i.freeSpaces.splice(e, 0, a);
      },
      ...
      intersectSpaces: function (e, t) {
        ...
        return o <= n || s <= a
          ? null
          : { leftStart: n, leftEnd: o, topStart: a, topEnd: s };
      },
      ...
      correctSubPixelValues: function () {
        var e,
          ...
          n,
          o = this;
        for (e = 0, t = o.freeSpaces.length - 1; e < t; e++)
          (i = o.freeSpaces[e]),
            (n = o.freeSpaces[e + 1]),
            n.topStart - i.topStart <= 1 && (n.topStart = i.topStart);
      },
          ...
          (t.freeSpaces = e.map(t.freeSpaces, function (i, n) {
            return (
              e.each(t.freeSpaces, function (e, t) {
                if (n !== e)
                  return t.leftStart <= i.leftStart &&
                    t.leftEnd >= i.leftEnd &&
                    t.topStart <= i.topStart &&
                    t.topEnd >= i.topEnd
                    ? ((i = null), !1)
                    : void 0;
              }),
        ...
        e.each(t.freeSpaces, function (i, n) {
          t.blocksOn.each(function (i, o) {
            ...
            if (a.pack === !0 && t.intersectSpaces(n, a)) {
              n.topStart - a.topNew - a.heightAndGap === -1 &&
      ...
      sortBlocksToPreventGaps: function () {
        var t = this;
        (t.blocksAreSorted = !0),
          t.blocksOn.sort(function (t, i) {
            var n = e(t).data("cbp"),
              o = e(i).data("cbp");
            return n.widthAndGap < o.widthAndGap
              ? 1
              : n.widthAndGap > o.widthAndGap
              ? -1
              : n.heightAndGap < o.heightAndGap
              ? 1
              : n.heightAndGap > o.heightAndGap
              ? -1
              : n.index > o.index
    ...
    (o.private = {
      ...
      browserInfo: function () {
        ...
        s.indexOf("MSIE 8.") !== -1
          ...
          : /android/gi.test(s)
          ? (a.browser = "android")
          : /iphone|ipad|ipod/gi.test(s)
          ? (a.browser = "ios")
          : /chrome/gi.test(s)
          ? (a.browser = "chrome")
          : (a.browser = ""),
          typeof a.styleSupport("perspective") !== n &&
            ((e = a.styleSupport("transition")),
            (a.transitionend = {
              WebkitTransition: "webkitTransitionEnd",
              transition: "transitionend",
            }[e]),
            (i = a.styleSupport("animation")),
            (a.animationend = {
            ...
            (a.transform = a.styleSupport("transform")),
            e && i && a.transform && (a.modernBrowser = !0));
      },
      styleSupport: function (e) {
        var t,
          n = "Webkit" + e.charAt(0).toUpperCase() + e.slice(1),
  ...
  (function (e, t, i, n) {
    ...
    o.public = {
      ...
      filter: function (t, i) {
        var a,
          s = o.private.checkInstance.call(this, "filter");
        if (!s.isAnimating) {
          if (
            ((s.isAnimating = !0),
            ...
            if (s.options.filterDeeplinking) {
              ...
              (location.href = r + "#cbpf=" + encodeURIComponent(t)),
                s.singlePage &&
                  s.singlePage.url &&
                  (s.singlePage.url = location.href);
            }
            (s.defaultFilter = t), (a = s.filterConcat(s.defaultFilter));
          }
          s.triggerEvent("filterStart", a),
            s.singlePageInline && s.singlePageInline.isOpen
              ? s.singlePageInline.close("promise", {
                  callback: function () {
                    s.computeFilter(a);
                  },
                })
      ...
      append: function (t, i) {
        ...
        return n.isAnimating || a.length < 1
          ? void (e.isFunction(i) && i.call(n, a))
          : ((n.isAnimating = !0),
            void (n.singlePageInline && n.singlePageInline.isOpen
      ...
      layout: function (t) {
        ...
        return (
          ...
          i.isAnimating || i.width <= 0
            ? void (e.isFunction(t) && t.call(i))
            : ("alignCenter" === i.options.gridAdjustment &&
    ...
    e.extend(o.prototype, {
      ...
      jumpDragToSlider: function (e) {
        ...
        o.options.scrollByPage
          ? ((t = o.cols * o.columnWidth), (i = o.cols))
          : ((t = o.columnWidth), (i = 1)),
          (e = Math.abs(e)),
          (n = Math.floor(e / t) * i),
          e % t > 20 && (n += i),
          (o.sliderActive = a
            ? Math.min(o.sliderActive + n, o.blocksOn.length - o.cols)
            : Math.max(0, o.sliderActive - n)),
          o.goToSlider();
      },
      ...
      enableDisableNavSlider: function () {
        var e,
          ...
          i = this;
        i.isRewindNav() ||
          ((t = i.isStartSlider() ? "addClass" : "removeClass"),
          i.navPrev[t]("cbp-nav-stop"),
          (t = i.isEndSlider() ? "addClass" : "removeClass"),
          i.navNext[t]("cbp-nav-stop")),
          i.options.showPagination &&
            ((e = i.options.scrollByPage
              ? Math.ceil(i.sliderActive / i.cols)
              : i.isEndSlider()
              ? i.navPaginationItems.length - 1
              : Math.floor(i.sliderActive / i.cols)),
          ...
          i.customPagination &&
            ((e = i.options.scrollByPage
              ? Math.ceil(i.sliderActive / i.cols)
              : i.isEndSlider()
              ? i.customPaginationItems.length - 1
              : Math.floor(i.sliderActive / i.cols)),
            i.customPaginationItems
              .removeClass(i.customPaginationClass)
              .eq(e)
              .addClass(i.customPaginationClass));
      },
      ...
      sliderLayout: function () {
        ...
        t.blocksOn.each(function (i, n) {
          ...
          (o.leftNew = t.columnWidth * i),
            (o.topNew = 0),
            t.sliderFreeSpaces.push({ topStart: o.heightAndGap });
        }),
      ...
      updateSliderPosition: function () {
        ...
        o.private.modernBrowser
          ? (e.$ul[0].style[o.private.transform] =
      ...
      dragSlider: function () {
        function a(t) {
          if (!m.sliderItemsLength()) {
            if (
              (y ? (g = t) : t.preventDefault(),
              m.options.auto && m.stopSliderAuto(),
              b)
            )
              return void e(u).one("click.cbp", function () {
                return !1;
              });
            (u = e(t.target)),
              (p = c(t).x),
              (d = 0),
              (h = -m.sliderActive * m.columnWidth),
              (f = m.columnWidth * (m.blocksOn.length - m.cols)),
              v.on(w.move, r),
              v.on(w.end, s),
              m.$obj.addClass("cbp-mode-slider-dragStart");
          }
        }
        function s(e) {
          m.$obj.removeClass("cbp-mode-slider-dragStart"),
            (b = !0),
            0 !== d
              ? (u.one("click.cbp", function (e) {
                  return !1;
                }),
                requestAnimationFrame(function () {
        ...
        function r(e) {
          (d = p - c(e).x),
            (d > 8 || d < -8) && e.preventDefault(),
            (m.isDrag = !0);
          var t = h - d;
          d < 0 && d < h
            ? (t = (h - d) / 5)
            : d > 0 && h - d < -f && (t = (f + h - d) / 5 - f),
            o.private.modernBrowser
              ? (m.$ul[0].style[o.private.transform] =
                  "translate3d(" + t + "px, 0px, 0)")
              : (m.$ul[0].style.left = t + "px");
        }
        function l() {
  ...
  (function (e, t, i, n) {
    ...
    (o.prototype.filterLayout = function () {
      ...
      i.$obj.addClass("cbp-animation-" + i.options.animationType),
        ...
        i.blocksOn2Off.length
          ? i.blocksOn2Off
              .last()
              .data("cbp")
              .wrapper.one(a.private.animationend, t)
          : i.blocksOff2On.length
          ? i.blocksOff2On
              .last()
              .data("cbp")
              .wrapper.one(a.private.animationend, t)
          ...
          i.$obj.addClass("cbp-animation-" + i.options.animationType),
            ...
            i.blocksOn.removeClass("cbp-item-off").each(function (t, i) {
              ...
              (n.left = n.leftNew),
                ...
                (i.style.left = n.left + "px"),
                (i.style.top = n.top + "px"),
                (n.wrapper[0].style[a.private.animationDelay] = 50 * t + "ms");
            });
      ...
      n.setAttribute("class", "cbp-wrapper-helper"),
        ...
        requestAnimationFrame(function () {
          i.$obj.addClass("cbp-animation-" + i.options.animationType),
            ...
            i.blocksOn.length
              ? i.$ul.one(a.private.animationend, t)
              : i.blocksOnInitial.length
              ? e(n).one(a.private.animationend, t)
              : t(),
            i.resizeMainContainer();
        });
    }),
      ...
      (t.parent = e),
        ...
        e.registerEvent("onMediaQueries", function (e) {
          e && e.hasOwnProperty("caption")
            ...
            : t.captionOn !== i.caption &&
              (t.destroy(), (t.captionOn = i.caption), t.init());
        }),
        t.init();
    }
    var a = e.fn.cubeportfolio.constructor;
            ...
            t.$obj.on("click.cbp", ".cbp-caption-defaultWrap", function (i) {
              if ((i.preventDefault(), !t.isAnimating)) {
                ...
                var n = e(this),
                  o = n.next(),
                  a = n.parent(),
                  s = { position: "relative", height: o.outerHeight(!0) },
          ...
          if (!(t.width <= 0)) {
            ...
            t.pushQueue("delayFrame", i),
              t.blocksOn.each(function (e, i) {
                i.style[a.private.animationDelay] =
      ...
      (t.wrap = t.filters.find(".cbp-l-filters-dropdownWrap").on({
        ...
        t.filters.each(function (o, a) {
          var s = e(a),
            ...
            c = {};
          s.hasClass("cbp-l-filters-dropdown") &&
            ((c.wrap = s.find(".cbp-l-filters-dropdownWrap")),
            (c.header = s.find(".cbp-l-filters-dropdownHeader")),
            (c.headerText = c.header.text())),
            i.$obj.cubeportfolio("showCounter", l),
            e.each(n, function (e, t) {
              if (l.filter('[data-filter="' + t + '"]').length)
                return (r = t), n.splice(e, 1), !1;
            }),
            e.data(a, "filterName", r),
            t.filterData.push(a),
            ...
            l.on("click.cbp", function () {
              ...
              if (!n.hasClass("cbp-filter-item-active") && !i.isAnimating) {
                t.filtersCallback(c, n),
                  e.data(a, "filterName", n.data("filter"));
    ...
    function o(t) {
      ...
      t.registerEvent("onMediaQueries", function (o) {
        (t.options.gapVertical =
          o && o.hasOwnProperty("gapVertical") ? o.gapVertical : i),
          (t.options.gapHorizontal =
            o && o.hasOwnProperty("gapHorizontal") ? o.gapHorizontal : n),
          t.blocks.each(function (i, n) {
            var o = e(n).data("cbp");
  ...
  (function (e, t, i, n) {
    ...
    function o(t) {
      var i = this;
      (i.parent = t),
        (i.options = e.extend({}, s, i.parent.options.plugins.inlineSlider)),
        i.runInit(),
  ...
  (function (e, t, i, n) {
    ...
    function o(t) {
      var i = this;
      (i.parent = t),
        (i.options = e.extend({}, a, i.parent.options.plugins.lazyLoad)),
        t.registerEvent(
          "initFinish",
          function () {
            i.loadImages(),
    ...
    var a = { loadingClass: "cbp-lazyload", threshold: 400 },
      ...
      r = e(t);
    (s.private.lazyLoadScroll = new s.private.publicEvents(
      "scroll.cbplazyLoad",
      50
    )),
        ...
        0 !== i.length &&
          ...
          i.each(function (i, n) {
            ...
            if (!t.isElementInScreen(n))
              return void o.addClass(t.options.loadingClass);
            var a = n.getAttribute("data-cbp-src");
            null === t.parent.checkSrc(e("<img>").attr("src", a))
              ? (t.removeLazyLoad(n, a), o.removeClass(t.options.loadingClass))
      ...
      (o.prototype.removeLazyLoad = function (t, i, n) {
        ...
        (t.src = i),
          ...
          n &&
            (s.private.modernBrowser
              ? e(t).one(s.private.transitionend, function () {
  ...
  (function (e, t, i, n) {
    ...
    function o(t) {
      var i = this;
      (i.parent = t),
        (i.options = e.extend({}, a, i.parent.options.plugins.loadMore)),
        (i.loadMore = e(i.options.element).find(".cbp-l-loadMore-link")),
        0 !== i.loadMore.length &&
          ((i.loadItems = i.loadMore.find(".cbp-l-loadMore-loadItems")),
          "0" === i.loadItems.text() &&
            i.loadMore.addClass("cbp-l-loadMore-stop"),
          t.registerEvent("filterStart", function (e) {
            i.populateItems().then(function () {
              var t = i.items.filter(e).length;
              t > 0
                ? (i.loadMore.removeClass("cbp-l-loadMore-stop"),
                  i.loadItems.html(t))
                : i.loadMore.addClass("cbp-l-loadMore-stop");
            });
          }),
    ...
    (o.prototype.populateItems = function () {
          ...
          e
            ...
            .done(function (i) {
              var n = e
                ...
                .join("");
              0 !== n.length &&
                e.each(e.parseHTML(n), function (i, n) {
                  e(n).hasClass("cbp-item")
                    ? (t.items = t.items.add(n))
                    : e.each(n.children, function (i, n) {
      ...
      (o.prototype.populateInsertItems = function (t) {
        var i = this,
          ...
          a = 0;
        return (
          i.items.each(function (t, s) {
            return (
              a !== i.options.loadItems &&
              void (o && "*" !== o
                ? e(s).filter(o).length && (n.push(s), (i.items[t] = null), a++)
                : (n.push(s), (i.items[t] = null), a++))
            );
          }),
          ...
          0 === n.length
            ...
            : void i.parent.$obj.cubeportfolio("append", n, t)
        );
      }),
      (o.prototype.click = function () {
        function e() {
          t.loadMore.removeClass("cbp-l-loadMore-loading");
          var e,
            i = t.parent.defaultFilter;
          (e = i && "*" !== i ? t.items.filter(i).length : t.items.length),
            0 === e
      ...
      (o.prototype.auto = function () {
        function i() {
          if (!r && !o.loadMore.hasClass("cbp-l-loadMore-stop")) {
            o.loadMore.offset().top - 200 > a.scrollTop() + a.height() ||
              ((r = !0),
              o
                .populateItems()
                .then(function () {
        ...
        function n() {
          var e,
            t = o.parent.defaultFilter;
          (e = t && "*" !== t ? o.items.filter(t).length : o.items.length),
            0 === e
              ? o.loadMore
                  .removeClass("cbp-l-loadMore-loading")
                  .addClass("cbp-l-loadMore-stop")
              : (o.loadItems.html(e), a.trigger("scroll.loadMore")),
            (r = !1),
            0 === o.items.length &&
              (s.private.loadMoreScroll.destroyEvent(o),
  ...
  (function (e, t, i, n) {
      ...
      r = {
        init: function (t, n) {
          ...
          if (
              ...
              e.each(r, function (t, i) {
                if (
                  (a.cubeportfolio.blocksOn.each(function (t, n) {
                    var s = e(n).find(
                      a.options.singlePageInlineDelegate + '[href="' + i + '"]'
                    );
            ...
            return void (a.localOptions = e.extend(
              {},
              s,
              ...
              if (
                (e.each(r, function (t, i) {
                  if (
                    (a.cubeportfolio.blocksOn.each(function (t, n) {
                      var s = e(n).find(
                        a.options.singlePageDelegate + '[href="' + i + '"]'
                      );
                      if (s.length) return (o = s), !1;
                    }),
                    o)
                ...
                p
                  ? (d = c
                      .closest(e(".cbp-item"))
                      .find('[data-cbp-singlePage="' + p + '"]'))
                  : a.cubeportfolio.blocksOn.each(function (t, i) {
                      var n = e(i);
                      n.not(".cbp-item-off") &&
                        n
        ...
        createMarkup: function () {
          ...
          "singlePage" === t.type &&
            ...
            "singlePage" === t.type &&
            t.options.singlePageStickyNavigation === !1
            ...
            e.each(n, function (t, i) {
              ...
              if (e.inArray(o, p) === -1) {
                ...
                if (/youtu\.?be/i.test(o)) {
                  ...
                  1 === d && (d = o.lastIndexOf("/") + 1),
                    (n = o.substring(d)),
                    /autoplay=/i.test(n) || (n += "&autoplay=1"),
                    (n = n.replace(/\?|&/, "?")),
                    (s = "//www.youtube.com/embed/" + n),
                    (l = "isYoutube");
                } else
                  /vimeo\.com/i.test(o)
                    ...
                    ? ((s =
                        o.indexOf("|") !== -1 ? o.split("|") : o.split("%7C")),
                      (l = "isSelfHostedVideo"))
                    : /\.mp3$/i.test(o) && ((s = o), (l = "isSelfHostedAudio"));
                r.dataArray.push({
                  src: s,
        ...
        openSinglePage: function (n, o) {
          ...
          if (!r.isOpen) {
            if (
              (r.cubeportfolio.singlePageInline &&
                r.cubeportfolio.singlePageInline.isOpen &&
                r.cubeportfolio.singlePageInline.close(),
              (r.isOpen = !0),
              (r.stopEvents = !1),
              (r.dataArray = []),
              (r.current = null),
            ...
            if (
              (e.each(n, function (t, i) {
                ...
                e.inArray(n, c) === -1 &&
                  (s === n && (r.current = l),
                  r.dataArray.push({ url: n, element: i }),
                  l++),
                  c.push(n);
              }),
              (r.counterTotal = r.dataArray.length),
              1 === r.counterTotal
                ? (r.nextButton.hide(), r.prevButton.hide())
                : (r.nextButton.show(), r.prevButton.show()),
              r.wrap.appendTo(i.body),
              (r.scrollTop = e(t).scrollTop()),
              ...
              r.wrap.one(a.private.transitionend, function () {
                e("html").css({
                  overflow: "hidden",
                  marginRight: t.innerWidth - e(i).width(),
                }),
                  r.wrap.addClass("cbp-popup-transitionend"),
                  r.options.singlePageStickyNavigation &&
              ...
              r.options.singlePageDeeplinking &&
                ((r.url = r.url.split("#cbp=")[0]),
                (location.href = r.url + "#cbp=" + r.dataArray[r.current].url)),
              e.isFunction(r.options.singlePageCallback) &&
                r.options.singlePageCallback.call(
                  r,
        ...
        openSinglePageInline: function (i, n, o) {
          ...
          if (
            ...
            return (
              (s = l.cubeportfolio.blocksOn.index(e(n).closest(".cbp-item"))),
              void (l.dataArray[l.current].url !== n.getAttribute("href") ||
              l.current !== s
          ...
          if (
            ...
            (l.dataArray = []),
            (l.current = null),
            null === (a = n.getAttribute("href")))
          )
            throw new Error(
              "HEI! Your clicked element doesn't have a href attribute."
            );
          if (
            ((r = e(n).closest(".cbp-item")[0]),
            i.each(function (e, t) {
              r === t && (l.current = e);
            }),
            (l.dataArray[l.current] = { url: a, element: n }),
            ...
            (l.top = p),
              ...
              i.each(function (t, i) {
                var n = e(i),
                  ...
                  a = o + n.height();
                a <= p ||
                  (o >= p && (l.blocksToMove = l.blocksToMove.add(i)),
                  o < p &&
                    a > p &&
                    ((l.top = a + l.options.gapHorizontal),
                    a - p > l.topDifference &&
                      (l.topDifference = a - p + l.options.gapHorizontal)));
              }),
            ...
            (l.top = d),
              ...
              i.each(function (t, i) {
                ...
                if (!(s <= d))
                  return a >= d - o / 2
                    ? void (l.blocksToMove = l.blocksToMove.add(i))
                    : void (
                        s > d &&
                        a < d &&
                        (s > l.top && (l.top = s),
                        s - d > l.topDifference && (l.topDifference = s - d))
                      );
              });
          }
          if (
                ...
                s.readyState
                  ? (s.onreadystatechange = function () {
                      ("loaded" != s.readyState &&
                        ...
                        ((s.onreadystatechange = null), n++, e[n] && o(e[n]));
                    })
                  : (s.onload = function () {
                      n++, e[n] && o(e[n]);
                    }),
                r ? (s.src = r) : (s.text = a.text),
                t.content[0].appendChild(s);
            };
          o(e[0]);
        },
        ...
        updateSinglePageInline: function (e, t) {
          ...
          i.content.html(e),
            ...
            0 !== i.localOptions.delay
              ? setTimeout(function () {
                  i.singlePageInlineIsOpen.call(i);
                }, i.localOptions.delay)
              : i.singlePageInlineIsOpen.call(i);
        },
        singlePageInlineIsOpen: function () {
          ...
          t.cubeportfolio.loadImages(t.wrap, function () {
            ...
            i.length
              ? (i.find(".cbp-slider-item").addClass("cbp-item"),
        ...
        isImage: function (t) {
          ...
          new Image(),
            i.tooggleLoading(!0),
            i.cubeportfolio.loadImages(
              e('<div><img src="' + t.src + '"></div>'),
              function () {
                i.updateImagesMarkup(
                  t.src,
                  t.title,
                  i.getCounterMarkup(
                    i.options.lightboxCounter,
                    i.current + 1,
                    i.counterTotal
                  )
                ),
        ...
        updateSelfHostedVideo: function (e, t, i) {
          ...
          for (n = 0; n < e.length; n++)
            /(\.mp4)/i.test(e[n])
              ? (a += '<source src="' + e[n] + '" type="video/mp4">')
              : /(\.ogg)|(\.ogv)/i.test(e[n])
              ? (a += '<source src="' + e[n] + '" type="video/ogg">')
              : /(\.webm)/i.test(e[n]) &&
                (a += '<source src="' + e[n] + '" type="video/webm">');
          (a +=
        ...
        lightboxJumpTo: function (e) {
          ...
          (i.current = i.getIndex(i.current + e)),
            (t = i.dataArray[i.current]),
            i[t.type](t);
        },
        singlePageJumpTo: function (t) {
          var i = this;
          (i.current = i.getIndex(i.current + t)),
            e.isFunction(i.options.singlePageCallback) &&
              (i.resetWrap(),
              i.contentWrap.scrollTop(0),
              i.wrap.addClass("cbp-popup-loading"),
              i.slider &&
                a.private.resize.destroyEvent(
                  e.data(i.slider[0], "cubeportfolio")
                ),
              i.options.singlePageCallback.call(
                i,
                i.dataArray[i.current].url,
                i.dataArray[i.current].element
              ),
              i.options.singlePageDeeplinking &&
                (location.href = i.url + "#cbp=" + i.dataArray[i.current].url));
        },
        resetWrap: function () {
          var e = this;
          "singlePage" === e.type &&
        ...
        close: function (i, n) {
          function o() {
            r.slider &&
              a.private.resize.destroyEvent(
                e.data(r.slider[0], "cubeportfolio")
              ),
              r.content.html(""),
              r.wrap.detach(),
              r.cubeportfolio.$obj.removeClass(
                "cbp-popup-singlePageInline-open cbp-popup-singlePageInline-close"
              ),
              "promise" === i &&
                e.isFunction(n.callback) &&
                n.callback.call(r.cubeportfolio);
          }
          function s() {
            var n = e(t).scrollTop();
            r.resetWrap(),
              e(t).scrollTop(n),
              r.options.singlePageInlineInFocus && "promise" !== i
                ? e("html,body")
                    .animate({ scrollTop: r.scrollTop }, 350)
                    .promise()
                    .then(function () {
                      o();
                    })
          ...
          var r = this;
          (r.isOpen = !1),
            "singlePageInline" === r.type
              ? "open" === i
                ? (r.wrap.removeClass("cbp-popup-singlePageInline-ready"),
                  e(r.dataArray[r.current].element)
                    .closest(".cbp-item")
                    .removeClass("cbp-singlePageInline-active"),
                  r.openSinglePageInline(n.blocks, n.currentBlock, n.fromOpen))
                : ((r.height = 0),
        ...
        preloadNearbyImages: function () {
          for (
            ...
            "isImage" === e.dataArray[t[i]].type &&
              e.cubeportfolio.checkSrc(e.dataArray[t[i]]);
        },
      },
      l = !1,
      c = !1,
    ...
    (o.prototype.run = function () {
        ...
        n.options.lightboxDelegate &&
          ...
          o.on("click.cbp", n.options.lightboxDelegate, function (i) {
            ...
            var o = e(this),
              ...
              l = [];
            r
              ? r.blocksOn.each(function (t, i) {
                  var o = e(i);
                  o.not(".cbp-item-off") &&
                    o.find(n.options.lightboxDelegate).each(function (t, i) {
                      a
                        ? e(i).attr("data-cbp-lightbox") === a && l.push(i)
                        : l.push(i);
                    });
                })
              : (l = a
                  ...
                  : s.find(n.options.lightboxDelegate)),
              n.lightbox.openLightbox(l, o[0]);
          })),
        (n.singlePage = null),
        n.options.singlePageDelegate &&
          !p &&
          ((p = !0),
          ...
          o.on("click.cbp", n.options.singlePageDelegate, function (i) {
            ...
            r
              ? r.blocksOn.each(function (t, i) {
                  var o = e(i);
                  o.not(".cbp-item-off") &&
                    o.find(n.options.singlePageDelegate).each(function (t, i) {
                      a
                        ? e(i).attr("data-cbp-singlePage") === a && l.push(i)
                        : l.push(i);
                    });
                })
              : (l = a
                  ...
                  : s.find(n.options.singlePageDelegate)),
              n.singlePage.openSinglePage(l, o[0]);
          })),
        (n.singlePageInline = null),
        n.options.singlePageInlineDelegate &&
          ((n.singlePageInline = Object.create(r)),
          ...
          n.$obj.on(
            ...
            function (t) {
              ...
              (!i || o - i > 300) &&
                n.singlePageInline.openSinglePageInline(n.blocksOn, this);
            }
          ));
    }),
      (o.prototype.detectScope = function (t) {
        var n, o, a;
        return (
          (n = t.closest(".cbp-popup-singlePageInline")),
          n.length
            ? ((a = t.closest(".cbp", n[0])), a.length ? a : n)
            : ((o = t.closest(".cbp-popup-singlePage")),
              o.length
                ? ((a = t.closest(".cbp", o[0])), a.length ? a : o)
                : ((a = t.closest(".cbp")), a.length ? a : e(i.body)))
        );
      }),
      (o.prototype.destroy = function () {
        var t = this.parent;
    ...
    function o(t) {
      ...
      (i.parent = t),
        ...
        i.searchInput.each(function (t, i) {
          ...
          n || (n = "*"), e.data(i, "searchData", { value: i.value, el: n });
        });
      var n = null;
            ...
            if (0 === s.length && i.searchNothing.length) {
              ...
              i.searchNothing.html(r),
                ...
                null === i.searchNothingHeight &&
                  (i.searchNothingHeight = i.searchNothing.outerHeight(!0)),
  ...
  (function (e, t, i, n) {
    ...
    function o(t) {
      var i = this;
      (i.parent = t),
        (i.options = e.extend({}, a, i.parent.options.plugins.slider));
      var n = e(i.options.pagination);
      n.length > 0 &&
        ((i.parent.customPagination = n),
    ...
    (o.prototype.sliderMarkup = function () {
      ...
      (t.sliderStopEvents = !1),
        ...
        t.options.auto &&
          ...
          t.startSliderAuto()),
        t.options.drag && s.private.modernBrowser && t.dragSlider();
    }),
    ...
    (e.infinitescroll = function (t, i, n) {
      ...
      (e.infinitescroll.prototype = {
        _binding: function (e) {
          ...
          return (
            (n.v = "2.0b2.120520"),
            n.behavior && this["_binding_" + n.behavior] !== t
              ? void this["_binding_" + n.behavior].call(this)
              : "bind" !== e && "unbind" !== e
              ? (this._debug("Binding value  " + e + " not valid"), !1)
              : ("unbind" === e
                  ? this.options.binder.unbind(
                      "smartscroll.infscr." + i.options.infid
                    )
                  : this.options.binder[e](
                      "smartscroll.infscr." + i.options.infid,
                      function () {
                        i.scroll();
                      }
        ...
        _create: function (i, n) {
          ...
          (o.path = o.path || this._determinepath(s)),
            ...
            o.pixelsFromNavToBottom === t &&
              ((o.pixelsFromNavToBottom =
                e(document).height() - e(o.navSelector).offset().top),
          ...
          return (
            ...
            (o.loading.finished =
              o.loading.finished ||
              function () {
                o.state.isBeyondMaxPage ||
                  o.loading.msg.fadeOut(o.loading.speed);
              }),
            (o.callback = function (i, s, r) {
              o.behavior &&
                i["_callback_" + o.behavior] !== t &&
                i["_callback_" + o.behavior].call(
                  e(o.contentSelector)[0],
                  s,
                  r
                ),
                n && n.call(e(o.contentSelector)[0], s, o, r),
                o.prefill && a.bind("resize.infinite-scroll", i._prefill);
            }),
            i.debug &&
        ...
        _error: function (e) {
          var i = this.options;
          if (i.behavior && this["_error_" + i.behavior] !== t)
            return void this["_error_" + i.behavior].call(this, e);
          "destroy" !== e && "end" !== e && (e = "unknown"),
            this._debug("Error", e),
        ...
        _loadcallback: function (i, n, o) {
          ...
          if (s.behavior && this["_loadcallback_" + s.behavior] !== t)
            return void this["_loadcallback_" + s.behavior].call(this, i, n);
          switch (l) {
            case "done":
            ...
            case "append":
              ...
              for (a = document.createDocumentFragment(); i[0].firstChild; )
                a.appendChild(i[0].firstChild);
              this._debug("contentSelector", e(s.contentSelector)[0]),
                e(s.contentSelector)[0].appendChild(a),
                (n = c.get());
          }
          if (
            (s.loading.finished.call(e(s.contentSelector)[0], s), s.animate)
          ) {
            var p =
              e(window).scrollTop() +
              e(s.loading.msg).height() +
              s.extraScrollPx +
              "px";
            e("html,body").animate({ scrollTop: p }, 800, function () {
        ...
        _nearbottom: function () {
          var i = this.options,
            n =
              ...
              i.binder.scrollTop() -
              e(window).height();
          return i.behavior && this["_nearbottom_" + i.behavior] !== t
            ? this["_nearbottom_" + i.behavior].call(this)
            : (this._debug("math:", n, i.pixelsFromNavToBottom),
        ...
        _setup: function () {
          var e = this.options;
          return e.behavior && this["_setup_" + e.behavior] !== t
            ? void this["_setup_" + e.behavior].call(this)
        ...
        beginAjax: function (i) {
          ...
          switch (
            ((n = e(
              e(i.contentSelector).is("table, tbody") ? "<tbody/>" : "<div/>"
            )),
            (o =
              "function" == typeof l
                ? l(i.state.currPage)
                : l.join(i.state.currPage)),
            r._debug("heading into ajax", o),
            (a =
              "html" === i.dataType || "json" === i.dataType
                ? i.dataType
                : "html+callback"),
            i.appendCallback && "html" === i.dataType && (a += "+callback"),
            a)
          ) {
            case "html+callback":
              r._debug("Using HTML via .load() method"),
                n.load(o + " " + i.itemSelector, t, function (e) {
                  r._loadcallback(n, e, o);
                });
              break;
            case "html":
              r._debug("Using " + a.toUpperCase() + " via $.ajax() method"),
                e.ajax({
                  url: o,
                  dataType: i.dataType,
                  complete: function (e, t) {
                    (s =
                      ...
                      s
                        ? r._loadcallback(n, e.responseText, o)
                        : r._error("end");
                  },
                });
              break;
                  ...
                  success: function (e, a, l) {
                    if (
                      ...
                      if (i.template !== t) {
                        var c = i.template(e);
                        n.append(c),
                          s ? r._loadcallback(n, c) : r._error("end");
                      } else
                        r._debug("template must be defined."), r._error("end");
        ...
        retrieve: function (i) {
          ...
          var n = this,
            o = n.options;
          return o.behavior && this["retrieve_" + o.behavior] !== t
            ? void this["retrieve_" + o.behavior].call(this, i)
            : o.state.isDestroyed
            ? (this._debug("Instance is destroyed"), !1)
            : ((o.state.isDuringAjax = !0),
              void o.loading.start.call(e(o.contentSelector)[0], o));
        },
        scroll: function () {
          var e = this.options,
            i = e.state;
          if (e.behavior && this["scroll_" + e.behavior] !== t)
            return void this["scroll_" + e.behavior].call(this);
          i.isDuringAjax ||
            i.isInvalidPage ||
            i.isDone ||
            i.isDestroyed ||
        ...
        switch (typeof t) {
          ...
          case "object":
            this.each(function () {
              ...
              n
                ? n.update(t)
                : ((n = new e.infinitescroll(t, i, this)),
  ...
  (function (e) {
    ...
    function t() {
      ...
      return (
        n.height ||
          (!(t = l.compatMode) && e.support.boxModel) ||
          ((i = "CSS1Compat" === t ? p : l.body),
      ...
      if (r.length) {
        ...
        for (o = o || t(), a = a || i(); n < r.length; n++)
          if (e.contains(p, s[n][0])) {
            ...
            if (!a || !o) return;
            d.top + c.height > a.top - h &&
            d.top + h < a.top + o.height &&
            d.left + c.width > a.left &&
            d.left < a.left + o.width
              ? u || l.data("inview", !0).trigger("inview", [!0])
              : u && l.data("inview", !1).trigger("inview", [!1]);
          }
      }
    }
    var o,
    ...
    (e.event.special.inview = {
      add: function (t) {
        r.push({ data: t, $element: e(this), element: this }),
      ...
      !p.addEventListener &&
        p.attachEvent &&
        p.attachEvent("onfocusin", function () {
          a = null;
        });
  }),
  (function (e, t) {
      ...
      i || (e.cssNumber[t] = !0),
        ...
        (e.cssHooks[t] = {
          ...
          set: function (i, n) {
            ...
            o.setFromString(t, n), e(i).css({ "transit:transform": o });
          },
        });
    }
    function l(e) {
        ...
        function (t, i, n, a) {
          ...
          "function" == typeof i && ((a = i), (i = void 0)),
            "object" == typeof i &&
              ((n = i.easing),
              (l = i.delay || 0),
              (c = void 0 === i.queue || i.queue),
              (a = i.complete),
              (i = i.duration)),
            "function" == typeof n && ((a = n), (n = void 0)),
            void 0 !== d.easing && ((n = d.easing), delete d.easing),
            void 0 !== d.duration && ((i = d.duration), delete d.duration),
            void 0 !== d.complete && ((a = d.complete), delete d.complete),
            void 0 !== d.queue && ((c = d.queue), delete d.queue),
            void 0 !== d.delay && ((l = d.delay), delete d.delay),
            void 0 === i && (i = e.fx.speeds._default),
            void 0 === n && (n = e.cssEase._default),
            (i = p(i));
          var h = s(d, i, n, l),
          ...
          var v = {},
            b = function (t) {
              ...
              m > 0 && g && e.transit.useTransitionEnd
                ? ((i = !0), r.bind(g, n))
  ...
  (function (e, t, i, n) {
    ...
    (e.jribbble.shots = function (t, i) {
          ...
          return function (i, n) {
            ...
            return (
              this.queue.add(function (i) {
                ...
                (i.url += "/" + t + "/"),
                  o.resource && ((i.url += o.resource), delete o.resource),
                  (i.url += p(e.extend(o, a)));
              }),
              this
            );
          };
      ...
      return (
        (s.prototype.attachments = a("attachments")),
        (s.prototype.buckets = a("buckets")),
        (s.prototype.likes = a("likes")),
        (s.prototype.projects = a("projects")),
        (s.prototype.rebounds = a("rebounds")),
        (s.prototype.comments = function (t, i) {
          var n = d([].slice.call(arguments)) || {},
            o = i || {};
          return (
            this.queue.add(function (t) {
  ...
  (function (e) {
    ...
    var t = {
      ...
      start: function (i) {
        (t.origin = lightcase.origin = this),
          (t.settings = lightcase.settings =
            e.extend(
              !0,
              {
                idPrefix: "lightcase-",
                ...
                markup: function () {
                  e("body").append(
                    (t.objects.overlay = e(
                      '<div id="' + t.settings.idPrefix + 'overlay"></div>'
                    )),
                    (t.objects.loading = e(
                      '<div id="' +
                        t.settings.idPrefix +
                    ...
                    t.objects.case.after(
                      (t.objects.nav = e(
                        '<div id="' + t.settings.idPrefix + 'nav"></div>'
                      ))
                    ),
                    t.objects.nav.append(
                      (t.objects.close = e(
                        '<a href="#" class="' +
                          t.settings.classPrefix +
                          'icon-close"><span>' +
                          t.settings.labels.close +
                          "</span></a>"
                      )),
                      (t.objects.prev = e(
                        '<a href="#" class="' +
                          t.settings.classPrefix +
                          'icon-prev"><span>' +
                          t.settings.labels["navigator.prev"] +
                          "</span></a>"
                      ).hide()),
                      (t.objects.next = e(
                        '<a href="#" class="' +
                          t.settings.classPrefix +
                          'icon-next"><span>' +
                          t.settings.labels["navigator.next"] +
                          "</span></a>"
                      ).hide()),
                      (t.objects.play = e(
                        '<a href="#" class="' +
                          t.settings.classPrefix +
                          'icon-play"><span>' +
                          t.settings.labels["navigator.play"] +
                          "</span></a>"
                      ).hide()),
                      (t.objects.pause = e(
                        '<a href="#" class="' +
                          t.settings.classPrefix +
                          'icon-pause"><span>' +
                          t.settings.labels["navigator.pause"] +
                          "</span></a>"
                      ).hide())
                    ),
                    t.objects.case.append(
                      (t.objects.content = e(
                        '<div id="' + t.settings.idPrefix + 'content"></div>'
                      )),
                      (t.objects.info = e(
                        '<div id="' + t.settings.idPrefix + 'info"></div>'
                      ))
                    ),
                    t.objects.content.append(
                      (t.objects.contentInner = e(
                        '<div class="' +
                          t.settings.classPrefix +
                          'contentInner"></div>'
                      ))
                    ),
                    t.objects.info.append(
                      (t.objects.sequenceInfo = e(
                        '<div id="' +
                          t.settings.idPrefix +
                          'sequenceInfo"></div>'
                      )),
                      (t.objects.title = e(
                        '<h4 id="' + t.settings.idPrefix + 'title"></h4>'
                      )),
                      (t.objects.caption = e(
                        '<p id="' + t.settings.idPrefix + 'caption"></p>'
                      ))
                    );
                },
                onInit: {},
              ...
              i,
              t.origin.data ? t.origin.data("lc-options") : {}
            )),
          t._callHooks(t.settings.onInit),
          (t.objectData = t._setObjectData(this)),
          t._cacheScrollPosition(),
          t._watchScrollInteraction(),
          t._addElements(),
          t._open(),
          (t.dimensions = t.getViewportDimensions());
      },
      get: function (e) {
        return t.objects[e];
      },
      ...
      _setObjectData: function (i) {
        var n = e(i),
          o = {
            title:
              t.settings.title ||
              n.attr(t._prefixAttributeName("title")) ||
              n.attr("title"),
            caption:
              t.settings.caption ||
              n.attr(t._prefixAttributeName("caption")) ||
              n.children("img").attr("alt"),
            url: t._determineUrl(),
            ...
            isPartOfSequenceWithSlideshow: t._isPartOfSequence(
              n.attr(t.settings.attr),
              ":slideshow"
            ),
        ...
        return (
          (o.sequenceInfo =
            o.currentIndex +
            1 +
            t.settings.labels["sequenceInfo.of"] +
            o.sequenceLength),
          (o.prevIndex = o.currentIndex - 1),
          (o.nextIndex = o.currentIndex + 1),
          o
        );
      },
      ...
      _determineLinkTarget: function () {
        return (
          t.settings.href ||
          e(t.origin).attr(t._prefixAttributeName("href")) ||
          e(t.origin).attr("href")
        );
      },
      _determineAttributeSelector: function () {
        ...
        if (void 0 !== t.cache.selector) n = t.cache.selector;
          ...
          t.settings.useCategories === !0 &&
          i.attr(t._prefixAttributeName("categories"))
        ) {
          var o = i.attr(t._prefixAttributeName("categories")).split(" ");
          e.each(o, function (e, i) {
            e > 0 && (n += ","),
              (n +=
                "[" + t._prefixAttributeName("categories") + '~="' + i + '"]');
          });
        } else
          n = "[" + t.settings.attr + '="' + i.attr(t.settings.attr) + '"]';
        return (t.cache.selector = n), n;
      },
      _determineUrl: function () {
        var i,
          n = t._verifyDataUrl(t._determineLinkTarget()),
          o = 0,
          a = 0;
        return (
          e.each(n, function (e, n) {
            t._devicePixelRatio() >= n.density &&
              n.density >= a &&
              t._matchMedia()("screen and (min-width:" + n.width + "px)")
                .matches &&
              n.width >= o &&
              ((o = n.width), (a = n.density), (i = n.url));
          }),
          i
        );
      },
      ...
      isSlideshowEnabled: function () {
        return (
          t.objectData.isPartOfSequence &&
          (t.settings.slideshow === !0 ||
            t.objectData.isPartOfSequenceWithSlideshow === !0)
        );
      },
      ...
      _createObject: function () {
        ...
        switch (t.objectData.type) {
          case "image":
            (i = e(new Image())),
              i.attr({ src: t.objectData.url, alt: t.objectData.title });
            break;
          case "inline":
            (i = e(
              '<div class="' + t.settings.classPrefix + 'inlineWrap"></div>'
            )),
              i.html(t._cloneObject(e(t.objectData.url))),
              e.each(t.settings.inline, function (e, n) {
          ...
          case "ajax":
            (i = e(
              ...
              e.each(t.settings.ajax, function (e, n) {
          ...
          case "flash":
            (i = e(
              ...
              e.each(t.settings.flash, function (e, t) {
                i.attr(e, t);
              });
            break;
          case "video":
            (i = e("<video></video>")),
              i.attr("src", t.objectData.url),
              e.each(t.settings.video, function (e, t) {
                i.attr(e, t);
              });
            break;
          default:
      ...
      _addObject: function (e) {
        t.objects.contentInner.html(e),
          t._loading("start"),
          t._callHooks(t.settings.onStart),
          t.settings.showSequenceInfo === !0 && t.objectData.isPartOfSequence
            ? (t.objects.sequenceInfo.html(t.objectData.sequenceInfo),
              t.objects.sequenceInfo.show())
            : (t.objects.sequenceInfo.empty(), t.objects.sequenceInfo.hide()),
          t.settings.showTitle === !0 &&
          void 0 !== t.objectData.title &&
          "" !== t.objectData.title
            ? (t.objects.title.html(t.objectData.title), t.objects.title.show())
            : (t.objects.title.empty(), t.objects.title.hide()),
          t.settings.showCaption === !0 &&
          void 0 !== t.objectData.caption &&
          "" !== t.objectData.caption
            ? (t.objects.caption.html(t.objectData.caption),
              t.objects.caption.show())
            : (t.objects.caption.empty(), t.objects.caption.hide());
      },
      _loadObject: function (i) {
        switch (t.objectData.type) {
          ...
          case "video":
            ...
            0 === t.objects.case.find("video").length
              ? t._showContent(i)
              : t.error();
            break;
          default:
      ...
      error: function () {
        ...
        i.html(t.settings.errorMessage),
          t.objects.contentInner.html(i),
          t._showContent(t.objects.contentInner);
      },
      _calculateDimensions: function (e) {
        ...
        var i = {
          objectWidth: e.attr("width")
            ? e.attr("width")
            : e.attr(t._prefixAttributeName("width")),
          objectHeight: e.attr("height")
            ? e.attr("height")
            : e.attr(t._prefixAttributeName("height")),
        };
        if (!t.settings.disableShrink)
          switch (
            ((i.maxWidth = parseInt(
              t.dimensions.windowWidth * t.settings.shrinkFactor
            )),
            (i.maxHeight = parseInt(
              t.dimensions.windowHeight * t.settings.shrinkFactor
            )),
            i.maxWidth > t.settings.maxWidth &&
              (i.maxWidth = t.settings.maxWidth),
            i.maxHeight > t.settings.maxHeight &&
              (i.maxHeight = t.settings.maxHeight),
            ...
            default:
              (isNaN(i.objectWidth) || i.objectWidth > i.maxWidth) &&
                ...
                ((isNaN(i.objectHeight) && "auto" !== i.objectHeight) ||
                  i.objectHeight > i.maxHeight) &&
                  !t.settings.forceHeight &&
                  (i.objectHeight = i.maxHeight);
          }
        t.settings.forceWidth
          ? (i.maxWidth = i.objectWidth)
          : e.attr(t._prefixAttributeName("max-width")) &&
            (i.maxWidth = e.attr(t._prefixAttributeName("max-width"))),
          t.settings.forceHeight
            ? (i.maxHeight = i.objectHeight)
            : e.attr(t._prefixAttributeName("max-height")) &&
              (i.maxHeight = e.attr(t._prefixAttributeName("max-height"))),
          t._adjustDimensions(e, i);
      },
      _adjustDimensions: function (e, i) {
        e.css({
          ...
          t.objects.case.css({ width: t.objects.contentInner.outerWidth() }),
          t.objects.case.css({
      ...
      _loading: function (e) {
        "start" === e
          ? (t.objects.case.addClass(t.settings.classPrefix + "loading"),
            t.objects.loading.show())
          : "end" === e &&
            (t.objects.case.removeClass(t.settings.classPrefix + "loading"),
            t.objects.loading.hide());
      },
        ...
        for (var n in i)
          if (i.hasOwnProperty(n))
            for (var o = i[n].split(","), a = 0; a < o.length; a++) {
              ...
              if (r.test(l) === !0 || ("inline" === n && e.indexOf(s) > -1))
                return n;
            }
        return "iframe";
      },
      _addElements: function () {
        (void 0 !== t.objects.case &&
          e("#" + t.objects.case.attr("id")).length) ||
          t.settings.markup();
      },
      _showContent: function (e) {
        switch (
          (t.objects.case.attr(
            t._prefixAttributeName("type"),
            t.objectData.type
          ),
          (t.cache.object = e),
          t._calculateDimensions(e),
          t._callHooks(t.settings.onFinish),
          t.settings.transitionIn)
        ) {
          case "scrollTop":
          case "scrollRight":
          case "scrollBottom":
          ...
          case "scrollVertical":
            t.transition.scroll(t.objects.case, "in", t.settings.speedIn),
              t.transition.fade(
                t.objects.contentInner,
                "in",
                t.settings.speedIn
              );
            break;
          case "elastic":
            t.objects.case.css("opacity") < 1 &&
              (t.transition.zoom(t.objects.case, "in", t.settings.speedIn),
              t.transition.fade(
                t.objects.contentInner,
                "in",
                t.settings.speedIn
          ...
          case "fade":
          case "fadeInline":
            t.transition.fade(t.objects.case, "in", t.settings.speedIn),
              t.transition.fade(
                t.objects.contentInner,
                "in",
                t.settings.speedIn
      ...
      _processContent: function () {
        switch (((t.isBusy = !0), t.settings.transitionOut)) {
          ...
          case "scrollVertical":
          case "scrollHorizontal":
            t.objects.case.is(":hidden")
              ? (t.transition.fade(t.objects.case, "out", 0, 0, function () {
                  t._loadContent();
                }),
                t.transition.fade(t.objects.contentInner, "out", 0))
              : t.transition.scroll(
                  t.objects.case,
                  "out",
                  t.settings.speedOut,
      ...
      _handleEvents: function () {
        t._unbindEvents(),
          t.objects.nav.children().not(t.objects.close).hide(),
          t.isSlideshowEnabled() &&
            ((t.settings.slideshowAutoStart !== !0 && !t.isSlideshowStarted) ||
            t.objects.nav.hasClass(t.settings.classPrefix + "paused")
              ? t._stopTimeout()
              : t._startTimeout()),
          t.settings.liveResize && t._watchResizeInteraction(),
          t.objects.close.click(function (e) {
            e.preventDefault(), t.close();
          }),
          t.settings.closeOnOverlayClick === !0 &&
            t.objects.overlay.css("cursor", "pointer").click(function (e) {
              e.preventDefault(), t.close();
            }),
          t.settings.useKeys === !0 && t._addKeyEvents(),
          t.objectData.isPartOfSequence &&
            (t.objects.nav.attr(t._prefixAttributeName("ispartofsequence"), !0),
            t.objects.nav.data("items", t._setNavigation()),
            t.objects.prev.click(function (e) {
              e.preventDefault(),
                (t.settings.navigateEndless !== !0 && t.item.isFirst()) ||
                  (t.objects.prev.unbind("click"),
                  (t.cache.action = "prev"),
                  t.objects.nav.data("items").prev.click(),
                  t.isSlideshowEnabled() && t._stopTimeout());
            }),
            t.objects.next.click(function (e) {
              e.preventDefault(),
                (t.settings.navigateEndless !== !0 && t.item.isLast()) ||
                  (t.objects.next.unbind("click"),
                  (t.cache.action = "next"),
                  t.objects.nav.data("items").next.click(),
                  t.isSlideshowEnabled() && t._stopTimeout());
            }),
            t.isSlideshowEnabled() &&
              (t.objects.play.click(function (e) {
            ...
            t.settings.swipe === !0 &&
              (e.isPlainObject(e.event.special.swipeleft) &&
                t.objects.case.on("swipeleft", function (e) {
                  e.preventDefault(),
                    t.objects.next.click(),
                    t.isSlideshowEnabled() && t._stopTimeout();
                }),
              e.isPlainObject(e.event.special.swiperight) &&
                t.objects.case.on("swiperight", function (e) {
                  e.preventDefault(),
                    t.objects.prev.click(),
                    t.isSlideshowEnabled() && t._stopTimeout();
                })));
      },
      ...
      _startTimeout: function () {
        (t.isSlideshowStarted = !0),
          t.objects.play.hide(),
          t.objects.pause.show(),
          (t.cache.action = "next"),
          t.objects.nav.removeClass(t.settings.classPrefix + "paused"),
      ...
      _stopTimeout: function () {
        t.objects.play.show(),
          t.objects.pause.hide(),
          t.objects.nav.addClass(t.settings.classPrefix + "paused"),
      ...
      _setNavigation: function () {
        ...
        return (
          t.objectData.currentIndex > 0
            ? t.objects.prev.show()
            : (o.prevItem = i.eq(n)),
          t.objectData.nextIndex <= n
            ? t.objects.next.show()
            : (o.next = i.eq(0)),
          t.settings.navigateEndless === !0 &&
            (t.objects.prev.show(), t.objects.next.show()),
          o
        );
      },
      item: {
      ...
      _cloneObject: function (e) {
        ...
        return (
          e.is(":hidden")
            ? (t._cacheObjectData(e),
              e.attr("id", t.settings.idPrefix + "temp-" + n).empty())
            : i.removeAttr("id"),
          i.show()
        );
      },
      isMobileDevice: function () {
        return !!navigator.userAgent
          .toLowerCase()
          .match(t.settings.mobileMatchExpression);
      },
      ...
      transition: {
        fade: function (e, i, n, o, a) {
          ...
          (!t.isOpen && s) ||
            ...
            t.support.transitions
              ? ((c[t.support.transition + "transition"] = n + "ms ease"),
                setTimeout(function () {
                  e.css(c),
                    setTimeout(function () {
                      e.css(t.support.transition + "transition", ""),
                        !a || (!t.isOpen && s) || a();
                    }, n);
                }, 15))
              : (e.stop(), e.animate(c, n, a)));
        },
        scroll: function (e, i, n, o) {
          ...
          if (t.isOpen || !a) {
            ...
            (l.opacity = c),
              ...
              e.css(l).show(),
              t.support.transitions
                ? ((d[t.support.transition + "transition"] = n + "ms ease"),
                  setTimeout(function () {
                    e.css(d),
                      setTimeout(function () {
                        e.css(t.support.transition + "transition", ""),
        ...
        zoom: function (e, i, n, o) {
          ...
          (!t.isOpen && a) ||
            ((s.opacity = r),
            (s[t.support.transition + "transform"] = l),
            (c.opacity = p),
            e.css(s).show(),
            t.support.transitions
              ? ((c[t.support.transition + "transform"] = d),
                (c[t.support.transition + "transition"] = n + "ms ease"),
                setTimeout(function () {
                  e.css(c),
                    setTimeout(function () {
                      e.css(t.support.transition + "transform", ""),
                        e.css(t.support.transition + "transition", ""),
                        !o || (!t.isOpen && a) || o();
                    }, n);
                }, 15))
              : (e.stop(), e.animate(c, n, o)));
        },
      },
      ...
      _cacheObjectData: function (i) {
        e.data(i, "cache", { id: i.attr("id"), content: i.html() }),
          (t.cache.originalObject = i);
      },
      _restoreObject: function () {
        var i = e('[id^="' + t.settings.idPrefix + 'temp-"]');
        i.attr("id", e.data(t.cache.originalObject, "cache").id),
          i.html(e.data(t.cache.originalObject, "cache").content);
      },
      resize: function () {
        t.isOpen &&
          (t.isSlideshowEnabled() && t._stopTimeout(),
          (t.dimensions = t.getViewportDimensions()),
          t._calculateDimensions(t.cache.object));
      },
      _cacheScrollPosition: function () {
        var i = e(window),
          n = e(document),
          o = { top: i.scrollTop(), left: i.scrollLeft() };
        (t.cache.scrollPosition = t.cache.scrollPosition || {}),
          t._assertContentInvisible()
            ? t.cache.cacheScrollPositionSkipped
              ? (delete t.cache.cacheScrollPositionSkipped,
                t._restoreScrollPosition())
              : (n.width() > i.width() &&
                  (t.cache.scrollPosition.left = o.left),
                n.height() > i.height() && (t.cache.scrollPosition.top = o.top))
            : (t.cache.cacheScrollPositionSkipped = !0);
      },
      ...
      _watchScrollInteraction: function () {
        e(window).scroll(t._cacheScrollPosition),
          e(window).resize(t._cacheScrollPosition);
      },
      _unwatchScrollInteraction: function () {
        e(window).off("scroll", t._cacheScrollPosition),
          e(window).off("resize", t._cacheScrollPosition);
      },
      ...
      _restoreScrollPosition: function () {
        e(window)
          .scrollTop(parseInt(t.cache.scrollPosition.top))
          .scrollLeft(parseInt(t.cache.scrollPosition.left))
          .resize();
      },
      _switchToFullScreenMode: function () {
        (t.settings.shrinkFactor = 1),
          (t.settings.overlayOpacity = 1),
          e("html").addClass(t.settings.classPrefix + "fullScreenMode");
      },
      _open: function () {
        switch (
          ((t.isOpen = !0),
          (t.support.transitions =
            !!t.settings.cssTransitions && t.isTransitionSupported()),
          (t.support.mobileDevice = t.isMobileDevice()),
          t.support.mobileDevice &&
            (e("html").addClass(t.settings.classPrefix + "isMobileDevice"),
            t.settings.fullScreenModeForMobile && t._switchToFullScreenMode()),
          t.settings.transitionIn ||
            (t.settings.transitionIn = t.settings.transition),
          t.settings.transitionOut ||
            (t.settings.transitionOut = t.settings.transition),
          t.settings.transitionIn)
        ) {
          case "fade":
          case "fadeInline":
          ...
          case "scrollHorizontal":
            t.objects.case.is(":hidden") &&
              (t.objects.close.css("opacity", 0),
              t.objects.overlay.css("opacity", 0),
              t.objects.case.css("opacity", 0),
              t.objects.contentInner.css("opacity", 0)),
              t.transition.fade(
                t.objects.overlay,
                "in",
                t.settings.speedIn,
                ...
                function () {
                  t.transition.fade(t.objects.close, "in", t.settings.speedIn),
                    t._handleEvents(),
                    t._processContent();
                }
              );
          ...
          default:
            t.transition.fade(
              ...
              t.settings.overlayOpacity,
              function () {
                t.transition.fade(t.objects.close, "in", 0),
                  t._handleEvents(),
                  t._processContent();
              }
            );
        }
        e("html").addClass(t.settings.classPrefix + "open"),
          t.objects.case.attr("aria-hidden", "false");
      },
      close: function () {
        switch (
          ((t.isOpen = !1),
          t.isSlideshowEnabled() &&
            (t._stopTimeout(),
            (t.isSlideshowStarted = !1),
            t.objects.nav.removeClass(t.settings.classPrefix + "paused")),
          t.objects.loading.hide(),
          t._unbindEvents(),
          t._unwatchResizeInteraction(),
          t._unwatchScrollInteraction(),
          e("html").removeClass(t.settings.classPrefix + "open"),
          t.objects.case.attr("aria-hidden", "true"),
          t.objects.nav.children().hide(),
          t._restoreScrollPosition(),
          t._callHooks(t.settings.onClose),
          t.settings.transitionOut)
        ) {
          case "fade":
          case "fadeInline":
      ...
      _unbindEvents: function () {
        t.objects.overlay.unbind("click"),
          e(document).unbind("keyup.lightcase"),
          t.objects.case.unbind("swipeleft").unbind("swiperight"),
          t.objects.prev.unbind("click"),
          t.objects.next.unbind("click"),
          t.objects.play.unbind("click"),
          t.objects.pause.unbind("click"),
          t.objects.close.unbind("click");
      },
      _cleanupDimensions: function () {
        ...
        t.objects.case.css({
          ...
          t.objects.contentInner.removeAttr("style").css("opacity", e),
          t.objects.contentInner.children().removeAttr("style");
      },
      cleanup: function () {
        t._cleanupDimensions(),
          t.objects.loading.hide(),
          t.objects.overlay.hide(),
          t.objects.case.hide(),
          t.objects.prev.hide(),
          t.objects.next.hide(),
          t.objects.play.hide(),
          t.objects.pause.hide(),
          t.objects.case.removeAttr(t._prefixAttributeName("type")),
          t.objects.nav.removeAttr(t._prefixAttributeName("ispartofsequence")),
          t.objects.contentInner.empty().hide(),
          t.objects.info.children().empty(),
          t.cache.originalObject && t._restoreObject(),
          t._callHooks(t.settings.onCleanup),
          (t.cache = {});
      },
    ...
    t._export(),
      (e.fn.lightcase = function (i) {
        return t._isPublicMethod(i)
          ? t[i].apply(this, Array.prototype.slice.call(arguments, 1))
          : "object" != typeof i && i
          ? void e.error("Method " + i + " does not exist on jQuery.lightcase")
          : t.init.apply(this, arguments);
      });
  })(jQuery),
  (function (e) {
    ...
    var t = {
      init: function (t) {
        ...
        return this.each(function () {
          var t = {
            init: function () {
              var i = e(this);
              t.prepareRanfolio.apply(i),
                t.buildRanfolio.apply(i),
                "" != n.delimiter && t.addDelimiter.apply(i),
                t.changeLinkColor.apply(i);
            },
            prepareRanfolio: function () {
              var t = e(this);
              t.addClass("vlt-ranfolio"),
                t.wrapInner('<div class="vlt-ranfolio-inner">'),
                t.find("a").addClass("vlt-ranfolio-link"),
                t.append(
                  '<div class="vlt-ranfolio-image"><img src="" alt=""></div>'
                ),
                1 == n.showCounter && t.addClass("vlt-ranfolio-counter");
            },
            changeLinkColor: function () {
              e(this)
                .find("a.vlt-ranfolio-link")
                .each(function () {
            ...
            buildRanfolio: function () {
              ...
              o.on("mouseenter", function () {
                ...
                a.stop().animate({ opacity: 1 }, n.duration);
              }),
                o.on("mouseleave", function () {
                  t.removeClass("hovered"), a.stop().animate({ opacity: 0 }, 0);
                });
            },
            addDelimiter: function () {
              ...
              e(
                '<span class="vlt-ranfolio-delimiter">' +
                  n.delimiter +
                  "</span>"
              ).insertAfter(i);
            },
      ...
      destroy: function () {
        this.removeClass("vlt-ranfolio vlt-ranfolio-counter hovered"),
          this.find("a").removeClass("vlt-ranfolio-link").attr("style", ""),
          this.find(".vlt-ranfolio-image").remove(),
          this.find(".vlt-ranfolio-delimiter").remove();
      },
    };
    e.fn.ranfolio = function (i) {
      return t[i]
        ? t[i].apply(this, Array.prototype.slice.call(arguments, 1))
        : "object" != typeof i && i
        ? void e.error("Method: " + i + " does not exists. jQuery.ranfolio")
        : t.init.apply(this, arguments);
    };
  })(jQuery),
  (function () {
      ...
      t = function (n, o) {
        ...
        function s() {
          ...
          t.attr("data-swiper-autoplay") &&
            (e = t.attr("data-swiper-autoplay") || _.params.autoplay),
            (_.autoplayTimeoutId = setTimeout(function () {
              _.params.loop
                ? (_.fixLoop(), _._slideNext(), _.emit("onAutoplay", _))
                : _.isEnd
                ? o.autoplayStopOnLast
                  ? _.stopAutoplay()
                  : (_._slideTo(0), _.emit("onAutoplay", _))
                : (_._slideNext(), _.emit("onAutoplay", _));
            }, e));
        }
        function r(t, i) {
          var n = e(t.target);
        ...
        function c(e) {
          ...
          if (
            ...
            ((_.isHorizontal() && 39 === t) || (!_.isHorizontal() && 40 === t))
          )
            return !1;
          if (
            !_.params.allowSwipeToPrev &&
            ((_.isHorizontal() && 37 === t) || (!_.isHorizontal() && 38 === t))
          )
            return !1;
          if (
            !(
            ...
            if (37 === t || 39 === t || 38 === t || 40 === t) {
              var i = !1;
              if (
                _.container.parents("." + _.params.slideClass).length > 0 &&
                0 ===
                  _.container.parents("." + _.params.slideActiveClass).length
              )
                return;
        ...
        function p(e) {
          ...
          return (
            ...
            n && !t && (t = n < 1 ? -1 : 1),
            o && !i && (i = o < 1 ? -1 : 1),
            { spinX: t, spinY: i, pixelX: n, pixelY: o }
          );
        }
        function d(e) {
          e.originalEvent && (e = e.originalEvent);
          ...
          if (0 !== t) {
            if ((_.params.mousewheelInvert && (t = -t), _.params.freeMode)) {
              var o =
                  _.getWrapperTranslate() + t * _.params.mousewheelSensitivity,
                a = _.isBeginning,
                s = _.isEnd;
              if (
                (o >= _.minTranslate() && (o = _.minTranslate()),
                o <= _.maxTranslate() && (o = _.maxTranslate()),
                _.setWrapperTransition(0),
                _.setWrapperTranslate(o),
                _.updateProgress(),
                _.updateActiveIndex(),
                ...
                _.emit("onScroll", _, e),
                _.params.autoplay &&
                  _.params.autoplayDisableOnInteraction &&
                  _.stopAutoplay(),
                0 === o || o === _.maxTranslate())
              )
                return;
            } else {
              if (
                new window.Date().getTime() - _.mousewheel.lastScrollTime >
                60
              )
                if (t < 0)
        ...
        for (var v in o)
          if (
            ...
            o[v] === window ||
            o[v] === document ||
            (void 0 !== i && o[v] instanceof i) ||
            ("undefined" != typeof jQuery && o[v] instanceof jQuery)
          )
            m[v] = o[v];
          else {
            m[v] = {};
        ...
        if (
          ...
          (void 0 !== e ||
            ...
            (_.getActiveBreakpoint = function () {
              ...
              for (e in _.params.breakpoints)
                _.params.breakpoints.hasOwnProperty(e) && i.push(e);
              i.sort(function (e, t) {
            ...
            (_.setBreakpoint = function () {
              ...
              if (e && _.currentBreakpoint !== e) {
                var t =
                    e in _.params.breakpoints
                      ? _.params.breakpoints[e]
                      : _.originalParams,
                  i =
                    _.params.loop && t.slidesPerView !== _.params.slidesPerView;
          ...
          (_.container[0].swiper = _),
            ...
            _.classNames.push(
              _.params.containerModifierClass + _.params.direction
            ),
            _.params.freeMode &&
              _.classNames.push(_.params.containerModifierClass + "free-mode"),
            _.support.flexbox ||
              (_.classNames.push(
                _.params.containerModifierClass + "no-flexbox"
              ),
              (_.params.slidesPerColumn = 1)),
            _.params.autoHeight &&
              _.classNames.push(_.params.containerModifierClass + "autoheight"),
            (_.params.parallax || _.params.watchSlidesVisibility) &&
            ...
            ["cube", "coverflow", "flip"].indexOf(_.params.effect) >= 0 &&
              (_.support.transforms3d
                ? ((_.params.watchSlidesProgress = !0),
                  _.classNames.push(_.params.containerModifierClass + "3d"))
                : (_.params.effect = "slide")),
            "slide" !== _.params.effect &&
              _.classNames.push(
                _.params.containerModifierClass + _.params.effect
              ),
            ...
            ("fade" !== _.params.effect && "flip" !== _.params.effect) ||
              ...
              (_.params.watchSlidesProgress = !0),
              (_.params.spaceBetween = 0),
              void 0 === g && (_.params.virtualTranslate = !0)),
            _.params.grabCursor &&
              _.support.touch &&
              (_.params.grabCursor = !1),
            ...
            _.params.pagination &&
              ...
              _.params.paginationClickable
                ? _.paginationContainer.addClass(
                    _.params.paginationModifierClass + "clickable"
                  )
                : (_.params.paginationClickable = !1),
              _.paginationContainer.addClass(
                _.params.paginationModifierClass + _.params.paginationType
              )),
            ...
            (_.rtl =
              _.isHorizontal() &&
              ("rtl" === _.container[0].dir.toLowerCase() ||
                "rtl" === _.container.css("direction"))),
            _.rtl && _.classNames.push(_.params.containerModifierClass + "rtl"),
            _.rtl && (_.wrongRTL = "-webkit-box" === _.wrapper.css("display")),
            _.params.slidesPerColumn > 1 &&
              _.classNames.push(_.params.containerModifierClass + "multirow"),
            _.device.android &&
              _.classNames.push(_.params.containerModifierClass + "android"),
            ...
            (_.imagesToLoad = []),
            (_.imagesLoaded = 0),
            (_.loadImage = function (e, t, i, n, o, a) {
              function s() {
                a && a();
              }
              var r;
            ...
            (_.preloadImages = function () {
              function e() {
                void 0 !== _ &&
                  null !== _ &&
                  _ &&
                  (void 0 !== _.imagesLoaded && _.imagesLoaded++,
                  _.imagesLoaded === _.imagesToLoad.length &&
                    (_.params.updateOnImagesReady && _.update(),
              ...
              for (var t = 0; t < _.imagesToLoad.length; t++)
                _.loadImage(
                  _.imagesToLoad[t],
                  _.imagesToLoad[t].currentSrc ||
                    _.imagesToLoad[t].getAttribute("src"),
                  _.imagesToLoad[t].srcset ||
                    _.imagesToLoad[t].getAttribute("srcset"),
                  _.imagesToLoad[t].sizes ||
                    _.imagesToLoad[t].getAttribute("sizes"),
                  !0,
                  e
                );
            }),
            ...
            (_.startAutoplay = function () {
              return (
                void 0 === _.autoplayTimeoutId &&
                !!_.params.autoplay &&
                !_.autoplaying &&
                ((_.autoplaying = !0), _.emit("onAutoplayStart", _), void s())
              );
            }),
            ...
            (_.pauseAutoplay = function (e) {
              _.autoplayPaused ||
                ...
                (_.autoplayPaused = !0),
                0 === e
                  ? ((_.autoplayPaused = !1), s())
                  : _.wrapper.transitionEnd(function () {
                      _ &&
                        ((_.autoplayPaused = !1),
                        _.autoplaying ? s() : _.stopAutoplay());
                    }));
            }),
            ...
            (_.updateContainerSize = function () {
              var e, t;
              (e =
                void 0 !== _.params.width
                  ? _.params.width
                  : _.container[0].clientWidth),
                (t =
                  void 0 !== _.params.height
                    ? _.params.height
                    : _.container[0].clientHeight),
                (0 === e && _.isHorizontal()) ||
                  (0 === t && !_.isHorizontal()) ||
                  ((e =
                    e -
                    parseInt(_.container.css("padding-left"), 10) -
                    parseInt(_.container.css("padding-right"), 10)),
                  (t =
                    t -
                    parseInt(_.container.css("padding-top"), 10) -
                    parseInt(_.container.css("padding-bottom"), 10)),
                  (_.width = e),
                  (_.height = t),
            ...
            (_.updateSlidesSize = function () {
              ...
              if (void 0 !== _.size) {
                "string" == typeof t &&
                  t.indexOf("%") >= 0 &&
                  (t = (parseFloat(t.replace("%", "")) / 100) * _.size),
                  (_.virtualSize = -t),
                  _.rtl
                    ? _.slides.css({ marginLeft: "", marginTop: "" })
                    : _.slides.css({ marginRight: "", marginBottom: "" });
                var s;
                _.params.slidesPerColumn > 1 &&
                  ((s =
                    Math.floor(_.slides.length / _.params.slidesPerColumn) ===
                    _.slides.length / _.params.slidesPerColumn
                      ? _.slides.length
                      : Math.ceil(_.slides.length / _.params.slidesPerColumn) *
                        _.params.slidesPerColumn),
                  "auto" !== _.params.slidesPerView &&
                    "row" === _.params.slidesPerColumnFill &&
                    (s = Math.max(
                      s,
                      _.params.slidesPerView * _.params.slidesPerColumn
                    )));
                var r,
                ...
                for (e = 0; e < _.slides.length; e++) {
                  ...
                  if (_.params.slidesPerColumn > 1) {
                    ...
                    "column" === _.params.slidesPerColumnFill
                      ...
                      : ((f = Math.floor(e / c)), (h = e - f * c)),
                      d
                        .css(
                          "margin-" + (_.isHorizontal() ? "top" : "left"),
                          0 !== f &&
                            _.params.spaceBetween &&
                            _.params.spaceBetween + "px"
                        )
                  ...
                  "none" !== d.css("display") &&
                    ("auto" === _.params.slidesPerView
                      ...
                      : ((r =
                          (_.size - (_.params.slidesPerView - 1) * t) /
                          _.params.slidesPerView),
                        _.params.roundLengths && (r = a(r)),
                        _.isHorizontal()
                          ? (_.slides[e].style.width = r + "px")
                          : (_.slides[e].style.height = r + "px")),
                    ...
                    _.params.centeredSlides
                      ? ((i = i + r / 2 + n / 2 + t),
                        ...
                        o % _.params.slidesPerGroup == 0 && _.snapGrid.push(i),
                        _.slidesGrid.push(i))
                      : (o % _.params.slidesPerGroup == 0 && _.snapGrid.push(i),
                        _.slidesGrid.push(i),
                        (i = i + r + t)),
                ...
                _.virtualSize =
                  Math.max(_.virtualSize, _.size) + _.params.slidesOffsetAfter;
                var g;
                if (
                  (_.rtl &&
                    _.wrongRTL &&
                    ("slide" === _.params.effect ||
                      "coverflow" === _.params.effect) &&
                    _.wrapper.css({
                  ...
                  _.params.slidesPerColumn > 1 &&
                    ((_.virtualSize = (r + _.params.spaceBetween) * s),
                    (_.virtualSize =
                      Math.ceil(_.virtualSize / _.params.slidesPerColumn) -
                      _.params.spaceBetween),
                    _.isHorizontal()
                      ? _.wrapper.css({
                          width: _.virtualSize + _.params.spaceBetween + "px",
                  ...
                  for (g = [], e = 0; e < _.snapGrid.length; e++)
                    _.snapGrid[e] < _.virtualSize + _.snapGrid[0] &&
                      g.push(_.snapGrid[e]);
                  _.snapGrid = g;
                }
                if (!_.params.centeredSlides) {
                  for (g = [], e = 0; e < _.snapGrid.length; e++)
                    _.snapGrid[e] <= _.virtualSize - _.size &&
                      g.push(_.snapGrid[e]);
                  (_.snapGrid = g),
                    Math.floor(_.virtualSize - _.size) -
                      Math.floor(_.snapGrid[_.snapGrid.length - 1]) >
                      1 && _.snapGrid.push(_.virtualSize - _.size);
                }
                0 === _.snapGrid.length && (_.snapGrid = [0]),
                  0 !== _.params.spaceBetween &&
                    (_.isHorizontal()
                      ? _.rtl
                        ? _.slides.css({ marginLeft: t + "px" })
                        : _.slides.css({ marginRight: t + "px" })
                      : _.slides.css({ marginBottom: t + "px" })),
                  _.params.watchSlidesProgress && _.updateSlidesOffset();
              }
            }),
            (_.updateSlidesOffset = function () {
              for (var e = 0; e < _.slides.length; e++)
                _.slides[e].swiperSlideOffset = _.isHorizontal()
                  ? _.slides[e].offsetLeft
            ...
            (_.currentSlidesPerView = function () {
              ...
              if (_.params.centeredSlides) {
                var n,
                  o = _.slides[_.activeIndex].swiperSlideSize;
                for (e = _.activeIndex + 1; e < _.slides.length; e++)
                  _.slides[e] &&
                    !n &&
                    ((o += _.slides[e].swiperSlideSize),
                    i++,
                    o > _.size && (n = !0));
                for (t = _.activeIndex - 1; t >= 0; t--)
                  _.slides[t] &&
                    !n &&
                    ((o += _.slides[t].swiperSlideSize),
                    i++,
                    o > _.size && (n = !0));
              } else
                for (e = _.activeIndex + 1; e < _.slides.length; e++)
                  _.slidesGrid[e] - _.slidesGrid[_.activeIndex] < _.size && i++;
              return i;
            }),
            (_.updateSlidesProgress = function (e) {
              if (
                (void 0 === e && (e = _.translate || 0), 0 !== _.slides.length)
              ) {
                void 0 === _.slides[0].swiperSlideOffset &&
                  _.updateSlidesOffset();
                var t = -e;
                _.rtl && (t = e),
                ...
                for (var i = 0; i < _.slides.length; i++) {
                  var n = _.slides[i],
                    o =
                      (t +
                        (_.params.centeredSlides ? _.minTranslate() : 0) -
                        n.swiperSlideOffset) /
                      (n.swiperSlideSize + _.params.spaceBetween);
                  if (_.params.watchSlidesVisibility) {
                    ...
                    ((a >= 0 && a < _.size) ||
                      (s > 0 && s <= _.size) ||
                      (a <= 0 && s >= _.size)) &&
                      _.slides.eq(i).addClass(_.params.slideVisibleClass);
                  }
            ...
            (_.updateProgress = function (e) {
              ...
              var t = _.maxTranslate() - _.minTranslate(),
                ...
                n = _.isEnd;
              0 === t
                ? ((_.progress = 0), (_.isBeginning = _.isEnd = !0))
                : ((_.progress = (e - _.minTranslate()) / t),
              ...
              for (t = 0; t < _.slidesGrid.length; t++)
                void 0 !== _.slidesGrid[t + 1]
                  ? n >= _.slidesGrid[t] &&
                    n <
                      _.slidesGrid[t + 1] -
                        (_.slidesGrid[t + 1] - _.slidesGrid[t]) / 2
                    ? (e = t)
                    : n >= _.slidesGrid[t] &&
                      n < _.slidesGrid[t + 1] &&
                      (e = t + 1)
            ...
            (_.updateRealIndex = function () {
              _.realIndex = parseInt(
                _.slides.eq(_.activeIndex).attr("data-swiper-slide-index") ||
                  _.activeIndex,
                10
              );
            }),
            (_.updateClasses = function () {
                    ...
                    ? _.wrapper
                        .children(
                          "." +
                            _.params.slideClass +
                            ":not(." +
                            _.params.slideDuplicateClass +
                            ')[data-swiper-slide-index="' +
                            _.realIndex +
                            '"]'
                        )
                        .addClass(_.params.slideDuplicateActiveClass)
                    : _.wrapper
                        .children(
                          "." +
                            _.params.slideClass +
                        ...
                        .addClass(_.params.slideDuplicateActiveClass));
              var i = t
                .next("." + _.params.slideClass)
                .addClass(_.params.slideNextClass);
              _.params.loop &&
                0 === i.length &&
                ((i = _.slides.eq(0)), i.addClass(_.params.slideNextClass));
              var n = t
                .prev("." + _.params.slideClass)
                .addClass(_.params.slidePrevClass);
              if (
                (_.params.loop &&
                  0 === n.length &&
                  ((n = _.slides.eq(-1)), n.addClass(_.params.slidePrevClass)),
                o.loop &&
                ...
                var a,
                  s = _.params.loop
                    ? Math.ceil(
                        (_.slides.length - 2 * _.loopedSlides) /
                          _.params.slidesPerGroup
                      )
                    : _.snapGrid.length;
                if (
                  (_.params.loop
                    ? ((a = Math.ceil(
                      ...
                      a > _.slides.length - 1 - 2 * _.loopedSlides &&
                        (a -= _.slides.length - 2 * _.loopedSlides),
                      a > s - 1 && (a -= s),
                      a < 0 &&
                        "bullets" !== _.params.paginationType &&
                        (a = s + a))
                  ...
                  "bullets" === _.params.paginationType &&
                    ...
                    _.paginationContainer.length > 1
                      ? _.bullets.each(function () {
                          e(this).index() === a &&
                            e(this).addClass(_.params.bulletActiveClass);
                        })
                      : _.bullets.eq(a).addClass(_.params.bulletActiveClass)),
                  "fraction" === _.params.paginationType &&
                    (_.paginationContainer
                      .find("." + _.params.paginationCurrentClass)
                      .text(a + 1),
                    _.paginationContainer
                      .find("." + _.params.paginationTotalClass)
                      .text(s)),
                ...
                "custom" === _.params.paginationType &&
                  ...
                  (_.paginationContainer.html(
                    _.params.paginationCustomRender(_, a + 1, s)
                  ),
              ...
              _.params.loop ||
                (_.params.prevButton &&
                  ...
                  (_.isBeginning
                    ? (_.prevButton.addClass(_.params.buttonDisabledClass),
                      _.params.a11y && _.a11y && _.a11y.disable(_.prevButton))
                    : (_.prevButton.removeClass(_.params.buttonDisabledClass),
                      _.params.a11y && _.a11y && _.a11y.enable(_.prevButton))),
                _.params.nextButton &&
                  _.nextButton &&
                  _.nextButton.length > 0 &&
                  (_.isEnd
                    ? (_.nextButton.addClass(_.params.buttonDisabledClass),
                      _.params.a11y && _.a11y && _.a11y.disable(_.nextButton))
                    : (_.nextButton.removeClass(_.params.buttonDisabledClass),
            ...
            (_.updatePagination = function () {
              if (
                _.params.pagination &&
                _.paginationContainer &&
                _.paginationContainer.length > 0
              ) {
                var e = "";
                if ("bullets" === _.params.paginationType) {
                  for (
                    ...
                    e += _.params.paginationBulletRender
                      ? _.params.paginationBulletRender(
                          _,
                          i,
                          _.params.bulletClass
                        )
                      : "<" +
                        _.params.paginationElement +
                        ' class="' +
                        _.params.bulletClass +
                        '"></' +
                        _.params.paginationElement +
                  ...
                  _.paginationContainer.html(e),
                    (_.bullets = _.paginationContainer.find(
                      "." + _.params.bulletClass
                    )),
                    _.params.paginationClickable &&
                      _.params.a11y &&
                      _.a11y &&
                      _.a11y.initPagination();
                }
                "fraction" === _.params.paginationType &&
                  ((e = _.params.paginationFractionRender
                    ? _.params.paginationFractionRender(
                        _,
                        _.params.paginationCurrentClass,
                        _.params.paginationTotalClass
                      )
                    : '<span class="' +
                      _.params.paginationCurrentClass +
                      '"></span> / <span class="' +
                  ...
                  _.paginationContainer.html(e)),
                  "progress" === _.params.paginationType &&
                    ((e = _.params.paginationProgressRender
                      ? _.params.paginationProgressRender(
                          _,
                          _.params.paginationProgressbarClass
                        )
                      : '<span class="' +
                        _.params.paginationProgressbarClass +
                        '"></span>'),
            ...
            (_.update = function (e) {
              function t() {
                _.rtl,
                  _.translate,
                  (i = Math.min(
                    Math.max(_.translate, _.maxTranslate()),
                    _.minTranslate()
                  )),
                  ...
                  ? (_.controller &&
                    ...
                    _.params.freeMode
                      ...
                      : (("auto" === _.params.slidesPerView ||
                        ...
                        _.isEnd &&
                        !_.params.centeredSlides
                          ? _.slideTo(_.slides.length - 1, 0, !1, !0)
                          : _.slideTo(_.activeIndex, 0, !1, !0)) || t())
            ...
            (_.onResize = function (e) {
              ...
              (_.params.allowSwipeToPrev = _.params.allowSwipeToNext = !0),
                _.updateContainerSize(),
                _.updateSlidesSize(),
                ("auto" === _.params.slidesPerView || _.params.freeMode || e) &&
                  _.updatePagination(),
                _.params.scrollbar && _.scrollbar && _.scrollbar.set(),
                _.controller &&
                  _.controller.spline &&
              ...
              if (_.params.freeMode) {
                ...
                _.updateClasses(),
                  (n =
                    ...
                    !_.params.centeredSlides
                      ? _.slideTo(_.slides.length - 1, 0, !1, !0)
                      : _.slideTo(_.activeIndex, 0, !1, !0));
              _.params.lazyLoading && !n && _.lazy && _.lazy.load(),
            ...
            (_.touchEvents = {
              start:
                _.support.touch || !_.params.simulateTouch
                  ? "touchstart"
                  : _.touchEventsDesktop.start,
              move:
                _.support.touch || !_.params.simulateTouch
                  ? "touchmove"
                  : _.touchEventsDesktop.move,
              end:
                _.support.touch || !_.params.simulateTouch
                  ? "touchend"
            ...
            (window.navigator.pointerEnabled ||
              window.navigator.msPointerEnabled) &&
              ("container" === _.params.touchEventsTarget
                ? _.container
                : _.wrapper
              ).addClass("swiper-wp8-" + _.params.direction),
            (_.initEvents = function (e) {
              var t = e ? "off" : "on",
                ...
                s = !!_.params.nested;
              if (_.browser.ie)
                n[i](_.touchEvents.start, _.onTouchStart, !1),
                  a[i](_.touchEvents.move, _.onTouchMove, s),
                  a[i](_.touchEvents.end, _.onTouchEnd, !1);
              else {
                if (_.support.touch) {
                  var r = !(
                    "touchstart" !== _.touchEvents.start ||
                    !_.support.passiveListener ||
                    !_.params.passiveListeners
                  ) && { passive: !0, capture: !1 };
                  n[i](_.touchEvents.start, _.onTouchStart, r),
                    n[i](_.touchEvents.move, _.onTouchMove, s),
                    n[i](_.touchEvents.end, _.onTouchEnd, r);
                }
                ((o.simulateTouch && !_.device.ios && !_.device.android) ||
                  (o.simulateTouch && !_.support.touch && _.device.ios)) &&
                  (n[i]("mousedown", _.onTouchStart, !1),
                  document[i]("mousemove", _.onTouchMove, s),
                  document[i]("mouseup", _.onTouchEnd, !1));
              }
              window[i]("resize", _.onResize),
                _.params.nextButton &&
                  _.nextButton &&
                  _.nextButton.length > 0 &&
                  (_.nextButton[t]("click", _.onClickNext),
                  _.params.a11y &&
                    _.a11y &&
                    _.nextButton[t]("keydown", _.a11y.onEnterKey)),
                _.params.prevButton &&
                  _.prevButton &&
                  _.prevButton.length > 0 &&
                  (_.prevButton[t]("click", _.onClickPrev),
                  _.params.a11y &&
                    _.a11y &&
                    _.prevButton[t]("keydown", _.a11y.onEnterKey)),
                _.params.pagination &&
                  _.params.paginationClickable &&
                  (_.paginationContainer[t](
                    "click",
                    "." + _.params.bulletClass,
                    _.onClickIndex
                  ),
                ...
                (_.params.preventClicks || _.params.preventClicksPropagation) &&
                  n[i]("click", _.preventClicks, !0);
            }),
            ...
            (_.preventClicks = function (e) {
              _.allowClick ||
                (_.params.preventClicks && e.preventDefault(),
                _.params.preventClicksPropagation &&
                  _.animating &&
            ...
            (_.updateClickedSlide = function (t) {
              var i = r(t, "." + _.params.slideClass),
                n = !1;
              if (i)
                for (var o = 0; o < _.slides.length; o++)
                  _.slides[o] === i && (n = !0);
              if (!i || !n)
                return (
              ...
              if (
                ((_.clickedSlide = i),
                (_.clickedIndex = e(i).index()),
                _.params.slideToClickedSlide &&
                ...
                var a,
                  ...
                  l =
                    "auto" === _.params.slidesPerView
                      ? _.currentSlidesPerView()
                      : _.params.slidesPerView;
                if (_.params.loop) {
                  if (_.animating) return;
                  (a = parseInt(
                    e(_.clickedSlide).attr("data-swiper-slide-index"),
                    10
                  )),
                    _.params.centeredSlides
                      ? s < _.loopedSlides - l / 2 ||
                        s > _.slides.length - _.loopedSlides + l / 2
                        ? (_.fixLoop(),
                          (s = _.wrapper
                            .children(
                              "." +
          ...
          (_.onTouchStart = function (t) {
            if (
              ...
              (B = "touchstart" === t.type) || !("which" in t) || 3 !== t.which)
            ) {
              if (_.params.noSwiping && r(t, "." + _.params.noSwipingClass))
                return void (_.allowClick = !0);
              if (!_.params.swipeHandler || r(t, _.params.swipeHandler)) {
                var i = (_.touches.currentX =
                    "touchstart" === t.type
                      ? t.targetTouches[0].pageX
                      : t.pageX),
                  n = (_.touches.currentY =
                    "touchstart" === t.type
                ...
                if (
                  !(
                    _.device.ios &&
                    _.params.iOSEdgeSwipeDetection &&
                    i <= _.params.iOSEdgeSwipeThreshold
                  )
                ) {
                  if (
                    ((x = !0),
            ...
            (_.onTouchMove = function (t) {
              if (
                ...
                if (B && _.params.touchReleaseOnEdges && !_.params.loop)
                  if (_.isHorizontal()) {
                    if (
                      (_.touches.currentX < _.touches.startX &&
                        _.translate <= _.maxTranslate()) ||
                      (_.touches.currentX > _.touches.startX &&
                        _.translate >= _.minTranslate())
                    )
                      return;
                  } else if (
                    (_.touches.currentY < _.touches.startY &&
                      _.translate <= _.maxTranslate()) ||
                    (_.touches.currentY > _.touches.startY &&
                      _.translate >= _.minTranslate())
                  )
                ...
                if (
                  ...
                  return (S = !0), void (_.allowClick = !1);
                if (
                  (T && _.emit("onTouchMove", _, t),
                  ...
                  if (
                    ...
                    (!_.isHorizontal() &&
                      ...
                      : ((i =
                          (180 *
                            Math.atan2(
                              Math.abs(_.touches.currentY - _.touches.startY),
                              Math.abs(_.touches.currentX - _.touches.startX)
                            )) /
                          Math.PI),
                        (k = _.isHorizontal()
                          ? i > _.params.touchAngle
                          : 90 - i > _.params.touchAngle));
                  }
                  if (
                    (k && _.emit("onTouchMoveOpposite", _, t),
                    void 0 === L &&
                      ((_.touches.currentX === _.touches.startX &&
                        _.touches.currentY === _.touches.startY) ||
                        (L = !0)),
                    ...
                    if (L) {
                      (_.allowClick = !1),
                        ...
                        t.preventDefault(),
                        _.params.touchMoveStopPropagation &&
                          !_.params.nested &&
                          t.stopPropagation(),
                        S ||
                          (o.loop && _.fixLoop(),
                          (E = _.getWrapperTranslate()),
                          _.setWrapperTransition(0),
                          _.animating &&
                            _.wrapper.trigger(
                          ...
                          !_.params.grabCursor ||
                            ...
                            _.setGrabCursor(!0)),
                        (S = !0);
                      var n = (_.touches.diff = _.isHorizontal()
                        ? _.touches.currentX - _.touches.startX
                        : _.touches.currentY - _.touches.startY);
                      ...
                      if (
                        ...
                        if (!(Math.abs(n) > _.params.threshold || P))
                          return void (A = E);
                        if (!P)
                          return (
                            (P = !0),
                            ...
                            (_.touches.startY = _.touches.currentY),
                            (A = E),
                            void (_.touches.diff = _.isHorizontal()
                              ? _.touches.currentX - _.touches.startX
                              : _.touches.currentY - _.touches.startY)
                          );
                      }
                      _.params.followFinger &&
                        ((_.params.freeMode || _.params.watchSlidesProgress) &&
                          _.updateActiveIndex(),
                        _.params.freeMode &&
                          (0 === O.length &&
                            O.push({
                          ...
                          O.push({
                            position:
                              _.touches[
                                _.isHorizontal() ? "currentX" : "currentY"
                              ],
            ...
            (_.onTouchEnd = function (t) {
              if (
                  ...
                  (_.allowClick &&
                    ...
                    n < 300 &&
                      ...
                      (j = setTimeout(function () {
                        _ &&
                          (_.params.paginationHide &&
                            _.paginationContainer.length > 0 &&
                            !e(t.target).hasClass(_.params.bulletClass) &&
                            _.paginationContainer.toggleClass(
                              _.params.paginationHiddenClass
                            ),
                          _.emit("onClick", _, t));
                      }, 300))),
                    n < 300 &&
                      i - D < 300 &&
                      (j && clearTimeout(j), _.emit("onDoubleTap", _, t))),
                  (D = Date.now()),
                  setTimeout(function () {
                    _ && (_.allowClick = !0);
                  }, 0),
                ...
                if (
                  ...
                  if (o > -_.maxTranslate())
                    return void (_.slides.length < _.snapGrid.length
                      ? _.slideTo(_.snapGrid.length - 1)
                      : _.slideTo(_.slides.length - 1));
                  if (_.params.freeModeMomentum) {
                    if (O.length > 1) {
                      ...
                      (_.velocity = r / l),
                        ...
                        Math.abs(_.velocity) <
                          _.params.freeModeMinimumVelocity && (_.velocity = 0),
                        (l > 150 ||
                          new window.Date().getTime() - a.time > 300) &&
                          (_.velocity = 0);
                    } else _.velocity = 0;
                    (_.velocity =
                      _.velocity * _.params.freeModeMomentumVelocityRatio),
                      (O.length = 0);
                    ...
                    var u,
                      ...
                      f =
                        20 *
                        Math.abs(_.velocity) *
                        _.params.freeModeMomentumBounceRatio;
                    if (d < _.maxTranslate())
                      _.params.freeModeMomentumBounce
                        ? (d + _.maxTranslate() < -f &&
                            (d = _.maxTranslate() - f),
                          (u = _.maxTranslate()),
                          (h = !0),
                      ...
                      (d =
                        Math.abs(_.snapGrid[g] - d) <
                          Math.abs(_.snapGrid[g - 1] - d) ||
                        "next" === _.swipeDirection
                          ? _.snapGrid[g]
                          : _.snapGrid[g - 1]),
                        _.rtl || (d = -d);
                    ...
                    if (0 !== _.velocity)
                      c = _.rtl
                        ? Math.abs((-d - _.translate) / _.velocity)
                        : Math.abs((d - _.translate) / _.velocity);
                    else if (_.params.freeModeSticky)
                      return void _.slideReset();
                    _.params.freeModeMomentumBounce && h
                      ? (_.updateProgress(u),
                  ...
                  return void (
                    (!_.params.freeModeMomentum ||
                      n >= _.params.longSwipesMs) &&
                ...
                for (
                  v = 0;
                  v < _.slidesGrid.length;
                  v += _.params.slidesPerGroup
                )
                  void 0 !== _.slidesGrid[v + _.params.slidesPerGroup]
                    ? o >= _.slidesGrid[v] &&
                      o < _.slidesGrid[v + _.params.slidesPerGroup] &&
                      ((b = v),
                      (w =
                        _.slidesGrid[v + _.params.slidesPerGroup] -
                        _.slidesGrid[v]))
                    : o >= _.slidesGrid[v] &&
                      ((b = v),
                      (w =
                        _.slidesGrid[_.slidesGrid.length - 1] -
                        _.slidesGrid[_.slidesGrid.length - 2]));
                var y = (o - _.slidesGrid[b]) / w;
                if (n > _.params.longSwipesMs) {
                  if (!_.params.longSwipes)
                    return void _.slideTo(_.activeIndex);
                  "next" === _.swipeDirection &&
                    (y >= _.params.longSwipesRatio
                      ? _.slideTo(b + _.params.slidesPerGroup)
                      : _.slideTo(b)),
                    "prev" === _.swipeDirection &&
                      (y > 1 - _.params.longSwipesRatio
                        ? _.slideTo(b + _.params.slidesPerGroup)
                        : _.slideTo(b));
                } else {
                  ...
                  "next" === _.swipeDirection &&
                    _.slideTo(b + _.params.slidesPerGroup),
                    "prev" === _.swipeDirection && _.slideTo(b);
                }
              }
            }),
            ...
            (_.slideTo = function (e, t, i, n) {
              void 0 === i && (i = !0),
                ...
                _.snapIndex >= _.snapGrid.length &&
                  (_.snapIndex = _.snapGrid.length - 1);
              var o = -_.snapGrid[_.snapIndex];
              if (
                (_.params.autoplay &&
                  _.autoplaying &&
                  (n || !_.params.autoplayDisableOnInteraction
                    ? _.pauseAutoplay(t)
                    : _.stopAutoplay()),
                _.updateProgress(o),
                _.params.normalizeSlideIndex)
                ...
                for (var a = 0; a < _.slidesGrid.length; a++)
                  -Math.floor(100 * o) >= Math.floor(100 * _.slidesGrid[a]) &&
                    (e = a);
              return !(
                (!_.params.allowSwipeToNext &&
                  o < _.translate &&
                ...
                (_.activeIndex = e),
                _.updateRealIndex(),
                (_.rtl && -o === _.translate) || (!_.rtl && o === _.translate)
                  ? (_.params.autoHeight && _.updateAutoHeight(),
                    _.updateClasses(),
                    "slide" !== _.params.effect && _.setWrapperTranslate(o),
                    1)
                  : (_.updateClasses(),
            ...
            (_.onTransitionStart = function (e) {
              void 0 === e && (e = !0),
                ...
                e &&
                  (_.emit("onTransitionStart", _),
                  _.activeIndex !== _.previousIndex &&
                    (_.emit("onSlideChangeStart", _),
                    _.activeIndex > _.previousIndex
                      ? _.emit("onSlideNextStart", _)
                      : _.emit("onSlidePrevStart", _)));
            }),
            (_.onTransitionEnd = function (e) {
              (_.animating = !1),
                ...
                e &&
                  (_.emit("onTransitionEnd", _),
                  _.activeIndex !== _.previousIndex &&
                    (_.emit("onSlideChangeEnd", _),
                    _.activeIndex > _.previousIndex
                      ? _.emit("onSlideNextEnd", _)
                      : _.emit("onSlidePrevEnd", _))),
                _.params.history &&
                  _.history &&
                  _.history.setHistory(_.params.history, _.activeIndex),
                _.params.hashnav && _.hashnav && _.hashnav.setHash();
            }),
            (_.slideNext = function (e, t, i) {
              return _.params.loop
                ? !_.animating &&
                    (_.fixLoop(),
                    _.container[0].clientLeft,
                    _.slideTo(_.activeIndex + _.params.slidesPerGroup, t, e, i))
                : _.slideTo(_.activeIndex + _.params.slidesPerGroup, t, e, i);
            }),
            ...
            (_.slidePrev = function (e, t, i) {
              return _.params.loop
                ? !_.animating &&
                    (_.fixLoop(),
                    _.container[0].clientLeft,
                    _.slideTo(_.activeIndex - 1, t, e, i))
                : _.slideTo(_.activeIndex - 1, t, e, i);
            }),
            ...
            (_.setWrapperTransition = function (e, t) {
              _.wrapper.transition(e),
                "slide" !== _.params.effect &&
                  _.effects[_.params.effect] &&
                  _.effects[_.params.effect].setTransition(e),
                _.params.parallax && _.parallax && _.parallax.setTransition(e),
                _.params.scrollbar &&
                  _.scrollbar &&
                  _.scrollbar.setTransition(e),
                _.params.control &&
                  _.controller &&
                  _.controller.setTransition(e, t),
                _.emit("onSetTransition", _, e);
            }),
            (_.setWrapperTranslate = function (e, t, i) {
              var n = 0,
                o = 0;
              _.isHorizontal() ? (n = _.rtl ? -e : e) : (o = e),
                _.params.roundLengths && ((n = a(n)), (o = a(o))),
                ...
                (_.translate = _.isHorizontal() ? n : o);
              var s,
                r = _.maxTranslate() - _.minTranslate();
              (s = 0 === r ? 0 : (e - _.minTranslate()) / r),
                s !== _.progress && _.updateProgress(e),
                t && _.updateActiveIndex(),
                "slide" !== _.params.effect &&
                  _.effects[_.params.effect] &&
                  _.effects[_.params.effect].setTranslate(_.translate),
                _.params.parallax &&
                  _.parallax &&
                  _.parallax.setTranslate(_.translate),
                _.params.scrollbar &&
                  _.scrollbar &&
                  _.scrollbar.setTranslate(_.translate),
                _.params.control &&
                  _.controller &&
                  _.controller.setTranslate(_.translate, i),
            ...
            (_.createLoop = function () {
              _.wrapper
                .children(
                  "." + _.params.slideClass + "." + _.params.slideDuplicateClass
                )
                .remove();
              var t = _.wrapper.children("." + _.params.slideClass);
              "auto" !== _.params.slidesPerView ||
                _.params.loopedSlides ||
                (_.params.loopedSlides = t.length),
                (_.loopedSlides = parseInt(
                  _.params.loopedSlides || _.params.slidesPerView,
                  10
                )),
                (_.loopedSlides =
                  _.loopedSlides + _.params.loopAdditionalSlides),
              ...
              for (
                t.each(function (i, a) {
                  var s = e(this);
                  i < _.loopedSlides && o.push(a),
                    i < t.length && i >= t.length - _.loopedSlides && n.push(a),
                ...
                _.wrapper.append(
                  e(o[i].cloneNode(!0)).addClass(_.params.slideDuplicateClass)
                );
              for (i = n.length - 1; i >= 0; i--)
                _.wrapper.prepend(
                  e(n[i].cloneNode(!0)).addClass(_.params.slideDuplicateClass)
                );
            }),
            ...
            (_.fixLoop = function () {
              var e;
              _.activeIndex < _.loopedSlides
                ? ((e = _.slides.length - 3 * _.loopedSlides + _.activeIndex),
                  (e += _.loopedSlides),
                  _.slideTo(e, 0, !1, !0))
                : (("auto" === _.params.slidesPerView &&
                    _.activeIndex >= 2 * _.loopedSlides) ||
                    _.activeIndex >
                      _.slides.length - 2 * _.params.slidesPerView) &&
                  ((e = -_.slides.length + _.activeIndex + _.loopedSlides),
                  (e += _.loopedSlides),
                  _.slideTo(e, 0, !1, !0));
            }),
            ...
            (_.removeSlide = function (e) {
              ...
              _.params.loop && _.createLoop(),
                (_.params.observer && _.support.observer) || _.update(!0),
                _.params.loop
                  ? _.slideTo(i + _.loopedSlides, 0, !1)
                  : _.slideTo(i, 0, !1);
            }),
                  ...
                  for (var t = 0; t < _.slides.length; t++) {
                    ...
                    if (
                      (_.isHorizontal()
                        ...
                        : ((c = l), (l = 0), (r = -s), (s = 0)),
                      (i[0].style.zIndex =
                        -Math.abs(Math.round(n)) + _.slides.length),
                      _.params.flip.slideShadows)
                    ) {
                      var p = _.isHorizontal()
                  ...
                  if (
                    ...
                    _.slides.eq(_.activeIndex).transitionEnd(function () {
                      if (
                        !i &&
                        _ &&
                        e(this).hasClass(_.params.slideActiveClass)
                      ) {
                        (i = !0), (_.animating = !1);
                        for (
                          var t = [
              ...
              cube: {
                setTranslate: function () {
                  ...
                  _.params.cube.shadow &&
                    (_.isHorizontal()
                      ? ((t = _.wrapper.find(".swiper-cube-shadow")),
                        0 === t.length &&
                          ((t = e('<div class="swiper-cube-shadow"></div>')),
                          _.wrapper.append(t)),
                        t.css({ height: _.width + "px" }))
                      : ((t = _.container.find(".swiper-cube-shadow")),
                        0 === t.length &&
                          ((t = e('<div class="swiper-cube-shadow"></div>')),
                  ...
                  for (var n = 0; n < _.slides.length; n++) {
                    ...
                    n % 4 == 0
                      ...
                      ? ((l = 0), (p = 4 * -s * _.size))
                      : (n - 2) % 4 == 0
                      ? ((l = _.size + 4 * s * _.size), (p = _.size))
                      : (n - 3) % 4 == 0 &&
                        ((l = -_.size), (p = 3 * _.size + 4 * _.size * s)),
                      _.rtl && (l = -l),
                  ...
                  if (
                    ...
                    if (_.isHorizontal())
                      t.transform(
                        "translate3d(0px, " +
                          (_.width / 2 + _.params.cube.shadowOffset) +
                          "px, " +
                          -_.width / 2 +
                          "px) rotateX(90deg) rotateZ(0deg) scale(" +
                          _.params.cube.shadowScale +
                          ")"
                      );
                    else {
                ...
                setTransition: function (e) {
                  _.slides
                    ...
                    _.params.cube.shadow &&
                      !_.isHorizontal() &&
                      _.container.find(".swiper-cube-shadow").transition(e);
                },
              },
              coverflow: {
                setTranslate: function () {
                  for (
                    var t = _.translate,
                      i = _.isHorizontal()
                        ...
                        : -t + _.height / 2,
                      n = _.isHorizontal()
                        ? _.params.coverflow.rotate
                        : -_.params.coverflow.rotate,
                      o = _.params.coverflow.depth,
                      a = 0,
                      s = _.slides.length;
                    a < s;
                    a++
                    ...
                    if (
                      (r.transform(m),
                      (r[0].style.zIndex = 1 - Math.abs(Math.round(p))),
                      _.params.coverflow.slideShadows)
                    ) {
                      var v = _.isHorizontal()
            ...
            (_.lazy = {
              ...
              loadImageInSlide: function (t, i) {
                if (
                  void 0 !== t &&
                  (void 0 === i && (i = !0), 0 !== _.slides.length)
                ) {
                  var n = _.slides.eq(t),
                    o = n.find(
                      "." +
                        _.params.lazyLoadingClass +
                        ":not(." +
                        _.params.lazyStatusLoadedClass +
                        "):not(." +
                        _.params.lazyStatusLoadingClass +
                        ")"
                    );
                  !n.hasClass(_.params.lazyLoadingClass) ||
                    n.hasClass(_.params.lazyStatusLoadedClass) ||
                    n.hasClass(_.params.lazyStatusLoadingClass) ||
                    (o = o.add(n[0])),
                    0 !== o.length &&
                      o.each(function () {
                        var t = e(this);
                        ...
                        _.loadImage(t[0], a || o, s, r, !1, function () {
                          if (void 0 !== _ && null !== _ && _) {
                            if (
                              ...
                              t
                                .addClass(_.params.lazyStatusLoadedClass)
                                .removeClass(_.params.lazyStatusLoadingClass),
                              n
                                .find(
                                  "." +
                                    _.params.lazyPreloaderClass +
                                    ", ." +
                                    _.params.preloaderClass
                                )
                                .remove(),
                              _.params.loop && i)
                            ) {
              ...
              onTransitionStart: function () {
                _.params.lazyLoading &&
                  (_.params.lazyLoadingOnTransitionStart ||
                    (!_.params.lazyLoadingOnTransitionStart &&
                      !_.lazy.initialImageLoaded)) &&
                  _.lazy.load();
              },
            ...
            (_.scrollbar = {
              ...
              setDragPosition: function (e) {
                var t = _.scrollbar,
                  ...
                  n =
                    i -
                    t.track.offset()[_.isHorizontal() ? "left" : "top"] -
                    t.dragSize / 2,
              ...
              draggableEvents: (function () {
                return _.params.simulateTouch !== !1 || _.support.touch
                  ? _.touchEvents
                  : _.touchEventsDesktop;
              })(),
              ...
              set: function () {
                if (_.params.scrollbar) {
                  ...
                  (t.track = e(_.params.scrollbar)),
                    _.params.uniqueNavElements &&
                      "string" == typeof _.params.scrollbar &&
                      t.track.length > 1 &&
                      1 === _.container.find(_.params.scrollbar).length &&
                      (t.track = _.container.find(_.params.scrollbar)),
            ...
            (_.controller = {
              ...
              getInterpolateFunction: function (e) {
                _.controller.spline ||
                  (_.controller.spline = _.params.loop
                    ? new _.controller.LinearSpline(_.slidesGrid, e.slidesGrid)
                    : new _.controller.LinearSpline(_.snapGrid, e.snapGrid));
              },
                ...
                function n(t) {
                  (e =
                    t.rtl && "horizontal" === t.params.direction
                      ? -_.translate
                      : _.translate),
                    "slide" === _.params.controlBy &&
                      (_.controller.getInterpolateFunction(t),
                      (a = -_.controller.spline.interpolate(-e))),
                    (a && "container" !== _.params.controlBy) ||
                      ((o =
                        (t.maxTranslate() - t.minTranslate()) /
                        (_.maxTranslate() - _.minTranslate())),
                      (a = (e - _.minTranslate()) * o + t.minTranslate())),
            ...
            (_.hashnav = {
              onHashCange: function (e, t) {
                ...
                i !== _.slides.eq(_.activeIndex).attr("data-hash") &&
                  _.slideTo(
                    _.wrapper
                      .children(
                        "." + _.params.slideClass + '[data-hash="' + i + '"]'
                      )
                      .index()
                  );
              },
                ...
                if (_.hashnav.initialized && _.params.hashnav)
                  if (
                    ...
                    window.history.replaceState(
                      null,
                      null,
                      "#" + _.slides.eq(_.activeIndex).attr("data-hash") || ""
                    );
                  else {
            ...
            (_.history = {
              init: function () {
                if (_.params.history) {
                  if (!window.history || !window.history.pushState)
                    return (
                      (_.params.history = !1), void (_.params.hashnav = !0)
                    );
              ...
              setHistoryPopState: function () {
                (_.history.paths = _.history.getPathValues()),
                  _.history.scrollToSlide(
                    _.params.speed,
                    _.history.paths.value,
                    !1
                  );
              },
            ...
            (_.disableMousewheelControl = function () {
              ...
              var t = _.container;
              return (
                "container" !== _.params.mousewheelEventsTarged &&
                  (t = e(_.params.mousewheelEventsTarged)),
                t.off(_.mousewheel.event, d),
            ...
            (_.zoom = {
              ...
              onGestureChange: function (e) {
                ...
                t.gesture.image &&
                  ...
                  t.scale < _.params.zoomMin &&
                    (t.scale =
                      _.params.zoomMin +
                      1 -
                      Math.pow(_.params.zoomMin - t.scale + 1, 0.5)),
              ...
              onTouchMove: function (e) {
                ...
                if (
                  t.gesture.image &&
                  0 !== t.gesture.image.length &&
                  ((_.allowClick = !1), t.image.isTouched && t.gesture.slide)
                ) {
                  t.image.isMoved ||
                    ((t.image.width = t.gesture.image[0].offsetWidth),
                    (t.image.height = t.gesture.image[0].offsetHeight),
                    (t.image.startX =
                      _.getTranslate(t.gesture.imageWrap[0], "x") || 0),
                    (t.image.startY =
                      _.getTranslate(t.gesture.imageWrap[0], "y") || 0),
              ...
              onTouchEnd: function (e, t) {
                ...
                if (i.gesture.image && 0 !== i.gesture.image.length) {
                  ...
                  0 !== i.velocity.x &&
                    ...
                    0 !== i.velocity.y &&
                      (o = Math.abs((l - i.image.currentY) / i.velocity.y));
                  var c = Math.max(n, o);
                      ...
                      : ((n.scale = n.currentScale =
                        ...
                        i
                          ? ((y = n.gesture.slide[0].offsetWidth),
                            ...
                            (f = u * n.scale),
                            (g = h * n.scale),
                            (m = Math.min(y / 2 - f / 2, 0)),
                            (v = Math.min(_ / 2 - g / 2, 0)),
                            (b = -m),
                            (w = -v),
                            (p = l * n.scale),
                            (d = c * n.scale),
              ...
              attachEvents: function (t) {
                ...
                if (_.params.zoom) {
                  ...
                  _.support.gestures
                    ? (_.slides[i]("gesturestart", _.zoom.onGestureStart, n),
                      _.slides[i]("gesturechange", _.zoom.onGestureChange, n),
                      _.slides[i]("gestureend", _.zoom.onGestureEnd, n))
                    : "touchstart" === _.touchEvents.start &&
                      (_.slides[i](
                        _.touchEvents.start,
                      ...
                      _.slides[i](
                        _.touchEvents.move,
                        _.zoom.onGestureChange,
                        n
                      ),
                      _.slides[i](_.touchEvents.end, _.zoom.onGestureEnd, n)),
                    _[i]("touchStart", _.zoom.onTouchStart),
                    _.slides.each(function (t, n) {
                      e(n).find("." + _.params.zoomContainerClass).length > 0 &&
                        e(n)[i](_.touchEvents.move, _.zoom.onTouchMove);
                    }),
          ...
          return (
            ...
            (_.off = function (e, t) {
              var i;
              if (((e = h(e)), void 0 === t))
                return (_.emitterEventListeners[e] = []), _;
              if (
                _.emitterEventListeners[e] &&
                0 !== _.emitterEventListeners[e].length
              ) {
                for (i = 0; i < _.emitterEventListeners[e].length; i++)
                  _.emitterEventListeners[e][i] === t &&
                    _.emitterEventListeners[e].splice(i, 1);
                return _;
              }
            }),
            (_.once = function (e, t) {
            ...
            (_.a11y = {
              ...
              onEnterKey: function (t) {
                13 === t.keyCode &&
                  (e(t.target).is(_.params.nextButton)
                    ? (_.onClickNext(t),
                      _.isEnd
                        ? _.a11y.notify(_.params.lastSlideMessage)
                        : _.a11y.notify(_.params.nextSlideMessage))
                    : e(t.target).is(_.params.prevButton) &&
                      (_.onClickPrev(t),
                      _.isBeginning
                        ? _.a11y.notify(_.params.firstSlideMessage)
                        : _.a11y.notify(_.params.prevSlideMessage)),
                  e(t.target).is("." + _.params.bulletClass) &&
                    e(t.target)[0].click());
              },
              liveRegion: e(
                '<span class="' +
                  _.params.notificationClass +
              ...
              initPagination: function () {
                _.params.pagination &&
                  ...
                  _.bullets.each(function () {
                    var t = e(this);
                    _.a11y.makeFocusable(t),
                      _.a11y.addRole(t, "button"),
                      _.a11y.addLabel(
                        t,
                        _.params.paginationBulletMessage.replace(
                          /{{index}}/,
                          t.index() + 1
                        )
                      );
              ...
              destroy: function () {
                _.a11y.liveRegion &&
                  _.a11y.liveRegion.length > 0 &&
                  _.a11y.liveRegion.remove();
              },
            }),
            (_.init = function () {
              _.params.loop && _.createLoop(),
                ...
                "slide" !== _.params.effect &&
                  _.effects[_.params.effect] &&
                  (_.params.loop || _.updateProgress(),
                  _.effects[_.params.effect].setTranslate()),
                _.params.loop
                  ? _.slideTo(
                      _.params.initialSlide + _.loopedSlides,
                      0,
                      _.params.runCallbacksOnInit
                    )
                  : (_.slideTo(
                    ...
                    0 === _.params.initialSlide &&
                      (_.parallax &&
                        _.params.parallax &&
                        _.parallax.setTranslate(),
                      _.lazy &&
                        _.params.lazyLoading &&
                        (_.lazy.load(), (_.lazy.initialImageLoaded = !0)))),
                _.attachEvents(),
                _.params.observer && _.support.observer && _.initObservers(),
                _.params.preloadImages &&
                  !_.params.lazyLoading &&
                  _.preloadImages(),
                _.params.zoom && _.zoom && _.zoom.init(),
                _.params.autoplay && _.startAutoplay(),
                _.params.keyboardControl &&
                  _.enableKeyboardControl &&
                  _.enableKeyboardControl(),
                _.params.mousewheelControl &&
                  _.enableMousewheelControl &&
                  _.enableMousewheelControl(),
                _.params.hashnavReplaceState &&
                  (_.params.replaceState = _.params.hashnavReplaceState),
            ...
            (_.cleanupStyles = function () {
              _.container
                ...
                _.paginationContainer &&
                  _.paginationContainer.length &&
                  _.paginationContainer.removeClass(
                    _.params.paginationHiddenClass
                  ),
                _.bullets &&
                  _.bullets.length &&
                  _.bullets.removeClass(_.params.bulletActiveClass),
                _.params.prevButton &&
                  e(_.params.prevButton).removeClass(
                    _.params.buttonDisabledClass
                  ),
                _.params.nextButton &&
                  e(_.params.nextButton).removeClass(
                    _.params.buttonDisabledClass
                  ),
                _.params.scrollbar &&
                  _.scrollbar &&
                  (_.scrollbar.track &&
                    _.scrollbar.track.length &&
                    _.scrollbar.track.removeAttr("style"),
                  _.scrollbar.drag &&
                    _.scrollbar.drag.length &&
                    _.scrollbar.drag.removeAttr("style"));
            }),
            (_.destroy = function (e, t) {
              _.detachEvents(),
                ...
                _.params.scrollbar &&
                  _.scrollbar &&
                  _.params.scrollbarDraggable &&
                  _.scrollbar.disableDraggable(),
                _.params.loop && _.destroyLoop(),
                t && _.cleanupStyles(),
                _.disconnectObservers(),
                _.params.zoom && _.zoom && _.zoom.destroy(),
                _.params.keyboardControl &&
                  _.disableKeyboardControl &&
                  _.disableKeyboardControl(),
                _.params.mousewheelControl &&
                  _.disableMousewheelControl &&
                  _.disableMousewheelControl(),
            ...
            (e.prototype = {
              ...
              on: function (e, i, n, o) {
                function a(e) {
                  ...
                  if (t(o).is(i)) n.call(o, e);
                    ...
                    for (var a = t(o).parents(), s = 0; s < a.length; s++)
                ...
                for (s = 0; s < this.length; s++)
                  if ("function" == typeof i || i === !1)
                    for (
                      "function" == typeof i &&
                        ((n = arguments[1]), (o = arguments[2] || !1)),
                        r = 0;
                      r < l.length;
                      r++
                    )
                      this[s].addEventListener(l[r], n, o);
                  else
                  ...
                  for (var s = 0; s < this.length; s++)
                    if ("function" == typeof t || t === !1)
                      "function" == typeof t &&
                        ...
                        this[s].removeEventListener(o[a], i, n);
                    else if (this[s].dom7LiveListeners)
                      for (var r = 0; r < this[s].dom7LiveListeners.length; r++)
                        this[s].dom7LiveListeners[r].listener === i &&
                          this[s].removeEventListener(
                            o[a],
                            this[s].dom7LiveListeners[r].liveListener,
                            n
                          );
                return this;
              },
              ...
              transitionEnd: function (e) {
                ...
                var i,
                  ...
                  o = this;
                if (e) for (i = 0; i < n.length; i++) o.on(n[i], t);
                return this;
              },
              width: function () {
              ...
              offset: function () {
                if (this.length > 0) {
                  ...
                  return { top: t.top + a - n, left: t.left + s - o };
                }
                return null;
              },
              css: function (e, t) {
              ...
              is: function (i) {
                ...
                if ("string" == typeof i) {
                  ...
                  if (a.webkitMatchesSelector)
                    return a.webkitMatchesSelector(i);
              ...
              prepend: function (t) {
                ...
                for (i = 0; i < this.length; i++)
                  if ("string" == typeof t) {
                    var o = document.createElement("div");
                    for (
                      o.innerHTML = t, n = o.childNodes.length - 1;
                      n >= 0;
                      n--
                    )
                      this[i].insertBefore(
                ...
                for (var i = t(e), n = 0; n < this.length; n++)
                  if (1 === i.length)
                    ...
                    for (var o = 0; o < i.length; o++)
                      i[o].parentNode.insertBefore(this[n].cloneNode(!0), i[o]);
              },
              ...
              find: function (t) {
                for (var i = [], n = 0; n < this.length; n++)
                  for (
                    var o = this[n].querySelectorAll(t), a = 0;
                    a < o.length;
                    a++
                  )
                    i.push(o[a]);
              ...
              children: function (i) {
                for (var n = [], o = 0; o < this.length; o++)
                  for (var a = this[o].childNodes, s = 0; s < a.length; s++)
                    i
  ...
  (function (e, t) {
    ...
    (l.prototype = {
          ...
          return (
            n.indexOf(".") > 0
              ...
              : e.each(i.__plugins, function (e, t) {
                  if (t.name.substring(t.name.length - n.length - 1) == "." + n)
                    return (o = t), !1;
                }),
            o
          );
      ...
      (e.Tooltipster.prototype = {
        __init: function (t, i) {
          ...
          if (
            ...
            if (
              ...
              l && (s = e(l)),
                s && s[0] ? n.__contentSet(s.first()) : n.__contentSet(o);
            }
        ...
        __contentInsert: function () {
          ...
          return (
            e._trigger({ type: "format", content: e.__Content, format: n }),
              ...
              switch (p) {
                case "circle":
                  var u = d[0],
                    ...
                    g = h - f,
                    m = u - f;
                  (c.origin.size.height = 2 * f),
                    (c.origin.size.width = c.origin.size.height),
                    (c.origin.windowOffset.left += m),
                    (c.origin.windowOffset.top += g);
                  break;
                case "rect":
                  var v = d[0],
                    b = d[1],
                    w = d[2],
                    y = d[3];
                  (c.origin.size.height = y - b),
                    (c.origin.size.width = w - v),
                    (c.origin.windowOffset.left += v),
                    (c.origin.windowOffset.top += b);
                  break;
                case "poly":
                  for (
                    var _ = 0, C = 0, x = 0, S = 0, T = "even", I = 0;
                    I < d.length;
                    I++
                  ) {
                    var k = d[I];
                  ...
                  (c.origin.size.height = S - C),
                    (c.origin.size.width = x - _),
                    (c.origin.windowOffset.left += _),
                    (c.origin.windowOffset.top += C);
              }
          }
          var A = function (e) {
            (c.origin.size.height = e.height),
              (c.origin.windowOffset.left = e.left),
              (c.origin.windowOffset.top = e.top),
              (c.origin.size.width = e.width);
          };
          for (
            t._trigger({
              type: "geometry",
              ...
              c.origin.windowOffset.right =
                c.origin.windowOffset.left + c.origin.size.width,
              c.origin.windowOffset.bottom =
                c.origin.windowOffset.top + c.origin.size.height,
              c.origin.offset.left =
                c.origin.windowOffset.left + c.window.scroll.left,
              c.origin.offset.top =
                c.origin.windowOffset.top + c.window.scroll.top,
              c.origin.offset.bottom =
                c.origin.offset.top + c.origin.size.height,
              c.origin.offset.right =
                c.origin.offset.left + c.origin.size.width,
              c.available.document = {
                bottom: {
              ...
              c.available.window = {
                bottom: {
                  height: Math.max(
                    c.window.size.height -
                      Math.max(c.origin.windowOffset.bottom, 0),
                    0
                  ),
                ...
                right: {
                  ...
                  width: Math.max(
                    c.window.size.width -
                      Math.max(c.origin.windowOffset.right, 0),
                    0
                  ),
                },
                top: {
            ...
            (e.__tracker = setInterval(function () {
              if (n(e._$origin) && n(e._$tooltip)) {
                ...
                if (e.__options.trackTooltip) {
                  ...
                  (s.height === e.__contentBcr.height &&
                    s.width === e.__contentBcr.width) ||
                    (e.reposition(), (e.__contentBcr = s));
                }
              } else e._close();
              ...
              if (
                ...
                var u = function () {
                  clearInterval(o.__tracker),
                    o._trigger({ type: "closing", event: t }),
                    o._$tooltip
                      .off("." + o.__namespace + "-triggerClose")
                      .removeClass("tooltipster-dying"),
                    e(r.window).off("." + o.__namespace + "-triggerClose"),
                    o.__$originParents.each(function (t, i) {
            ...
            if (
              ("closed" == o.__state &&
                ...
                a &&
                  ...
                  (a = o.__options.functionBefore.call(o, o, {
                    event: t,
                    origin: o._$origin[0],
                  }))),
              ...
              var s,
                l = function () {
                  "stable" != o.__state && o.__stateSet("stable"),
                    e.each(o.__callbacks.open, function (e, t) {
                      t.call(o, o, {
                        origin: o._$origin[0],
              ...
              if ("closed" !== o.__state)
                ...
                if (
                  ...
                  o.__options.interactive && (c = c.add(o._$tooltip)),
                    o.__options.triggerClose.mouseleave &&
                      ((p += "mouseenter." + o.__namespace + "-triggerClose "),
                      (d += "mouseleave." + o.__namespace + "-triggerClose ")),
                    o.__options.triggerClose.touchleave &&
                      r.hasTouchCapability &&
                      ((p += "touchstart." + o.__namespace + "-triggerClose"),
                      (d +=
                        "touchend." +
                        o.__namespace +
                    ...
                    c
                      .on(d, function (e) {
                        if (
                          o._touchIsTouchEvent(e) ||
                          !o._touchIsEmulatedEvent(e)
                        ) {
                          var t =
                            "mouseleave" == e.type
                              ? o.__options.delay
                ...
                o.__options.triggerClose.originClick &&
                  ...
                  (o.__options.triggerClose.click ||
                    (o.__options.triggerClose.tap && r.hasTouchCapability)) &&
                    setTimeout(function () {
                      if ("closed" != o.__state) {
                        var t = "",
                          i = e(r.window.document.body);
                        o.__options.triggerClose.click &&
                          (t += "click." + o.__namespace + "-triggerClose "),
                          o.__options.triggerClose.tap &&
                            r.hasTouchCapability &&
                            (t +=
                              "touchend." + o.__namespace + "-triggerClose"),
                          i.on(t, function (t) {
                            o._touchIsMeaningfulEvent(t) &&
                              (o._touchRecordEvent(t),
                              (o.__options.interactive &&
                                e.contains(o._$tooltip[0], t.target)) ||
                                o._close(t));
                          }),
                          o.__options.triggerClose.tap &&
                            r.hasTouchCapability &&
        ...
        return (
          ...
          this.each(function () {
            ...
            o
              ...
              : (i = !0),
              i &&
                ((a = new e.Tooltipster(this, t[0])),
                o || (o = []),
                o.push(a.__namespace),
                n.data("tooltipster-ns", o),
                n.data(a.__namespace, a),
                a.__options.functionInit &&
                  a.__options.functionInit.call(a, a, { origin: this }),
                a._trigger("init")),
              e.tooltipster.__instancesLatestArr.push(a);
          }),
          this
        );
      }),
    ...
    c.indexOf("msie") != -1
      ? (r.IE = parseInt(c.split("msie")[1]))
      : c.toLowerCase().indexOf("trident") !== -1 && c.indexOf(" rv:11") !== -1
      ? (r.IE = 11)
      : c.toLowerCase().indexOf("edge/") != -1 &&
        (r.IE = parseInt(c.toLowerCase().split("edge/")[1]));
      ...
      e.tooltipster._plugin({
        ...
        instance: {
          ...
          __optionsFormat: function () {
            var t = this;
            if (
              ((t.__options = t.__instance._optionsExtract(p, t.__defaults())),
          ...
          __reposition: function (t, i) {
            ...
            switch (
              (p && r.removeClass("tooltipster-" + p),
              e.each(["window", "document"], function (n, p) {
                var d = null;
                if (
                  ...
                  1 == d ||
                    (0 != d &&
                      0 == c &&
                      ("window" != p || o.__options.viewportAware)))
                )
                  for (var n = 0; n < o.__options.side.length; n++) {
                    var u = { horizontal: 0, vertical: 0 },
                      h = o.__options.side[n];
                    "top" == h || "bottom" == h
                      ? (u.vertical = o.__options.distance[h])
                      : (u.horizontal = o.__options.distance[h]),
                      o.__sideChange(r, h),
                          ...
                          var r = {
                            ...
                            f =
                              "natural" == n
                                ? l.free()
                                : l.constrain(
                                    i.geo.available[p][h].width - u.horizontal,
                                    i.geo.available[p][h].height - u.vertical
                                  ),
                            g = f.measure();
                          if (
                            ((r.size = g.size),
                            ...
                            "natural" == n
                              ? i.geo.available[p][h].width >=
                                  r.outerSize.width &&
                                i.geo.available[p][h].height >=
                                  r.outerSize.height
                                ? (r.fits = !0)
                                : (r.fits = !1)
                              : (r.fits = g.fits),
                            ...
                            "natural" == r.mode &&
                            (r.fits ||
                              r.size.width <= i.geo.available[p][h].width)
                          )
                            return !1;
                        }
                      });
            ...
            var h, f;
            "top" == n.side || "bottom" == n.side
              ? ((h = { prop: "left", val: n.target - n.coord.left }),
                (f = n.size.width - this.__options.minIntersection))
              : ((h = { prop: "top", val: n.target - n.coord.top }),
                (f = n.size.height - this.__options.minIntersection)),
              h.val < this.__options.minIntersection
                ? (h.val = this.__options.minIntersection)
                : h.val > f && (h.val = f);
            var g;
            (g = i.geo.origin.fixedLineage
        ...
        if (this.stop !== !0) {
          ...
          n.timeout = setTimeout(function () {
            ...
            if ("^" === o.charAt(0)) {
              var a = 1;
              /^\^\d+/.test(o) &&
                ((o = /\d+/.exec(o)[0]), (a += o.length), (i = parseInt(o))),
            ...
            if ("html" === n.contentType) {
              ...
              if ("<" === s || "&" === s) {
                ...
                for (
                  ...
                  ((r += e.substr(t).charAt(0)), !(++t + 1 > e.length));
